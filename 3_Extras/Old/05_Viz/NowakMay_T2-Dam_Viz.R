...
## Basic model checks ##
Fit_NM_T2_Dam_Summ <- print(Fit_NM_T2_Dam, pars=c("r", "b", "c", "u", "sigma"),
...
fit_Overlay <- mcmc_dens_overlay(Fit_NM_T2_Dam, parms); fit_Overlay
...
## "Real data" ##
StanData <- read_csv(here('./02_Data/NowakMay_StochSim_T2-Dam.csv'))
