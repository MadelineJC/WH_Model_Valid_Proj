...
points(1:21, lynx_hare_df$Lynx, type = "l", col = "firebrick2", lwd = 2, lty = 2)
points(1:21, lynx_hare_df$Hare, type = "l", col = "orchid", lwd = 2, lty = 2)
...
plot(lynx_hare_df$Year, lynx_hare_df$Hare, type = "l", main = "Stochastic LV Model (Five Implementations)", sub = "Initial Conditions: As per Carpenter", xlab = "Time", ylab = "Population Abundance", ylim = c(0, 120), col = "orchid", lwd = 2)
lines(lynx_hare_df$Year, lynx_hare_df$Lynx, col = "firebrick2", lwd = 2)
lines(lynx_hare_df$Year, BC_Stoch_List[[1]]$Hare, col = "orchid", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[1]]$Lynx, col = "firebrick2", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[2]]$Hare, col = "orchid", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[2]]$Lynx, col = "firebrick2", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[3]]$Hare, col = "orchid", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[3]]$Lynx, col = "firebrick2", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[4]]$Hare, col = "orchid", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[4]]$Lynx, col = "firebrick2", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[5]]$Hare, col = "orchid", lwd = 2, lty = 3)
lines(lynx_hare_df$Year, BC_Stoch_List[[5]]$Lynx, col = "firebrick2", lwd = 2, lty = 3)
```
