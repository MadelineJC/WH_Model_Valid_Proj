...
hare_lynx_df <- read.csv("3_Extras/Old/Chapter1Review/Bob-Carpenter_Example/hudson-bay-lynx-hare.csv")
...
lines(hare_lynx_df$Year, BC_Stoch_List[[2]]$Hare, col = "orchid", lwd = 2, lty = 3)
lines(hare_lynx_df$Year, BC_Stoch_List[[2]]$Lynx, col = "firebrick2", lwd = 2, lty = 3)
