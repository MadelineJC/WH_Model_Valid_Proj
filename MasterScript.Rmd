...
plot(Antia_Stoch_List[[4]]$Time, Antia_Stoch_List[[4]]$P, type = "l", main = "Stochastic Simulation of Antia et al. (1994) Model (4)", xlab = "Time", ylab = "Population Abundance", col = "forestgreen", lwd = 2)
...
plot(ModFentonPerkins_1_Stoch_List[[4]]$Time, ModFentonPerkins_1_Stoch_List[[4]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (4)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_1_Stoch_List[[4]]$I)), col = "forestgreen", lwd = 2)
...
plot(ModFentonPerkins_2_SLC_Stoch_List[[4]]$Time, ModFentonPerkins_2_SLC_Stoch_List[[4]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (4)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_2_SLC_Stoch_List[[4]]$I)), col = "forestgreen", lwd = 2)
...
plot(ModFentonPerkins_2_DO_Stoch_List[[4]]$Time, ModFentonPerkins_2_DO_Stoch_List[[4]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (4)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_2_DO_Stoch_List[[4]]$I)), col = "forestgreen", lwd = 2)
...
plot(ModFentonPerkins_3_Stoch_List[[4]]$Time, ModFentonPerkins_3_Stoch_List[[4]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (4)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_3_Stoch_List[[4]]$I)), col = "forestgreen", lwd = 2)
...
# Troubleshooting: Time Series Length

Here, we'll be fitting the adapted Fenton and Perkins (II) model to a shorter time series that contains fewer oscillations, and the Lotka-Volterra model to a longer time series (more oscillations), to determine how differences between model expectations and data (in terms of phase) affect estimability.
...
```{r}
ModFentonPerkins_2_SLC_Stoch_1_SHORT <- ModFentonPerkins_2_SLC_Stoch_List[[1]][1:15, ]
plot(ModFentonPerkins_2_SLC_Stoch_1_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_1_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_SLC_Stoch_1_SHORT)))
lines(ModFentonPerkins_2_SLC_Stoch_1_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_1_SHORT$I)

ModFentonPerkins_2_SLC_Stoch_2_SHORT <- ModFentonPerkins_2_SLC_Stoch_List[[2]][1:15, ]
ModFentonPerkins_2_SLC_Stoch_3_SHORT <- ModFentonPerkins_2_SLC_Stoch_List[[3]][1:15, ]
ModFentonPerkins_2_SLC_Stoch_4_SHORT <- ModFentonPerkins_2_SLC_Stoch_List[[4]][1:15, ]
ModFentonPerkins_2_SLC_Stoch_5_SHORT <- ModFentonPerkins_2_SLC_Stoch_List[[5]][1:15, ]

## Comparing to empirical data
Mod_FP_2_SLC_Det_SHORT <- Mod_FP_2_SLC_Det[1:140, ]

plot(ModFentonPerkins_2_SLC_Stoch_1_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_1_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_SLC_Stoch_1_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_SLC_Stoch_1_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_1_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$I, col = "cornflowerblue", lty = 3)

plot(ModFentonPerkins_2_SLC_Stoch_2_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_2_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_SLC_Stoch_2_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_SLC_Stoch_2_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_2_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$I, col = "cornflowerblue", lty = 3)

plot(ModFentonPerkins_2_SLC_Stoch_3_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_3_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_SLC_Stoch_3_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_SLC_Stoch_3_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_3_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$I, col = "cornflowerblue", lty = 3)

plot(ModFentonPerkins_2_SLC_Stoch_4_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_4_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_SLC_Stoch_4_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_SLC_Stoch_4_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_4_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$I, col = "cornflowerblue", lty = 3)

plot(ModFentonPerkins_2_SLC_Stoch_5_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_5_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_SLC_Stoch_5_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_SLC_Stoch_5_SHORT$Time, ModFentonPerkins_2_SLC_Stoch_5_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_SLC_Det_SHORT$Time, Mod_FP_2_SLC_Det_SHORT$I, col = "cornflowerblue", lty = 3)
```

From this group, **Time Series 2** is the only one stat really stay in phase, so we'll use that.

### Damping Oscillations

```{r}
nrow(ModFentonPerkins_2_DO_Stoch_List[[1]]); nrow(ModFentonPerkins_2_DO_Stoch_List[[2]])
nrow(ModFentonPerkins_2_DO_Stoch_List[[3]]); nrow(ModFentonPerkins_2_DO_Stoch_List[[4]])
nrow(ModFentonPerkins_2_DO_Stoch_List[[5]])

ModFentonPerkins_2_DO_Stoch_2_SHORT <- ModFentonPerkins_2_DO_Stoch_List[[2]][1:15, ]
plot(ModFentonPerkins_2_DO_Stoch_2_SHORT$Time, ModFentonPerkins_2_DO_Stoch_2_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_DO_Stoch_2_SHORT)))
lines(ModFentonPerkins_2_DO_Stoch_2_SHORT$Time, ModFentonPerkins_2_DO_Stoch_2_SHORT$I)

ModFentonPerkins_2_DO_Stoch_3_SHORT <- ModFentonPerkins_2_DO_Stoch_List[[3]][1:15, ]
ModFentonPerkins_2_DO_Stoch_4_SHORT <- ModFentonPerkins_2_DO_Stoch_List[[4]][1:15, ]
ModFentonPerkins_2_DO_Stoch_5_SHORT <- ModFentonPerkins_2_DO_Stoch_List[[5]][1:15, ]

## Comparing to empirical data
Mod_FP_2_DO_Det_SHORT <- Mod_FP_2_DO_Det[1:140, ]

plot(ModFentonPerkins_2_DO_Stoch_2_SHORT$Time, ModFentonPerkins_2_DO_Stoch_2_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_DO_Stoch_2_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_DO_Stoch_2_SHORT$Time, ModFentonPerkins_2_DO_Stoch_2_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$I, col = "cornflowerblue", lty = 3)

plot(ModFentonPerkins_2_DO_Stoch_3_SHORT$Time, ModFentonPerkins_2_DO_Stoch_3_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_DO_Stoch_3_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_DO_Stoch_3_SHORT$Time, ModFentonPerkins_2_DO_Stoch_3_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$I, col = "cornflowerblue", lty = 3)

plot(ModFentonPerkins_2_DO_Stoch_4_SHORT$Time, ModFentonPerkins_2_DO_Stoch_4_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_DO_Stoch_4_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_DO_Stoch_4_SHORT$Time, ModFentonPerkins_2_DO_Stoch_4_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$I, col = "cornflowerblue", lty = 3)

plot(ModFentonPerkins_2_DO_Stoch_5_SHORT$Time, ModFentonPerkins_2_DO_Stoch_5_SHORT$P, type = "l", ylim = c(0, max(ModFentonPerkins_2_DO_Stoch_5_SHORT)), col = "forestgreen")
lines(ModFentonPerkins_2_DO_Stoch_5_SHORT$Time, ModFentonPerkins_2_DO_Stoch_5_SHORT$I, col = "cornflowerblue")
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$P, col = "forestgreen", lty = 3)
lines(Mod_FP_2_DO_Det_SHORT$Time, Mod_FP_2_DO_Det_SHORT$I, col = "cornflowerblue", lty = 3)

ModFentonPerkins_2_DO_Stoch_SHORT_List <- list(ModFentonPerkins_2_DO_Stoch_2_SHORT,
                                               ModFentonPerkins_2_DO_Stoch_3_SHORT,
                                               ModFentonPerkins_2_DO_Stoch_4_SHORT,
                                               ModFentonPerkins_2_DO_Stoch_5_SHORT)
```

These all look good, so we'll use all of these.
...
TT <- seq(1, 60, 1) # Twenty years, assessed every year
...
plot(1:nrow(BC_Stoch_List[[1]]), BC_Stoch_List[[1]]$Hare, type = "l", col = "orchid", lwd = 2)
lines(1:nrow(BC_Stoch_List[[1]]), BC_Stoch_List[[1]]$Lynx, col = "firebrick2", lwd = 2)
lines(1:nrow(LV_DetSim_BC), LV_DetSim_BC$Hare, col = "orchid", lwd = 2, lty = 3)
lines(1:nrow(LV_DetSim_BC), LV_DetSim_BC$Lynx, col = "firebrick2", lwd = 2, lty = 3)
```

## Fitting

```{r}
## Mod. Fenton and Perkins, SLC
N <- length(ModFentonPerkins_2_SLC_Stoch_2_SHORT$Time) - 1
ts <- 1:N
y_init <- c(ModFentonPerkins_2_SLC_Stoch_2_SHORT$P[1], ModFentonPerkins_2_SLC_Stoch_2_SHORT$I[1])
y <- as.matrix(ModFentonPerkins_2_SLC_Stoch_2_SHORT[2:(N + 1), 2:3])
y <- cbind(y[ , 1], y[ , 2]); 
ModFentonPerkins_2_SLC_Stoch_2_SHORT_StanData <- list(N = N, ts = ts, y_init = y_init, y = y)

model <- stan_model("1_Models/FP_2_AllParms.stan")

ModFentonPerkins_2_SLC_Stoch_2_SHORT_Fit <- sampling(model, data = ModFentonPerkins_2_SLC_Stoch_2_SHORT_StanData, chains = 4, iter = 1000, cores = 4, seed = 123)

## Mod. Fenton and Perkins, DO
ModFentonPerkins_2_DO_Stoch_SHORT_StanData_List <- list()
for (i in 1:4){
  ModFentonPerkins_2_DO_Stoch_SHORT <- ModFentonPerkins_2_DO_Stoch_SHORT_List[[i]]
  N <- length(ModFentonPerkins_2_DO_Stoch_SHORT$Time) - 1
  ts <- 1:N
  y_init <- c(ModFentonPerkins_2_DO_Stoch_SHORT$P[1], ModFentonPerkins_2_DO_Stoch_SHORT$I[1])
  y <- as.matrix(ModFentonPerkins_2_DO_Stoch_SHORT[2:(N + 1), 2:3])
  y <- cbind(y[ , 1], y[ , 2]); 
  ModFentonPerkins_2_DO_StanData <- list(N = N, ts = ts, y_init = y_init, y = y)
  ModFentonPerkins_2_DO_Stoch_SHORT_StanData_List[[i]] <- ModFentonPerkins_2_DO_StanData
}

ModFentonPerkins_2_DO_Stoch_2_SHORT_Fit <- sampling(model, data = ModFentonPerkins_2_DO_Stoch_SHORT_StanData_List[[1]], chains = 4, iter = 1000, cores = 4, seed = 123)
ModFentonPerkins_2_DO_Stoch_3_SHORT_Fit <- sampling(model, data = ModFentonPerkins_2_DO_Stoch_SHORT_StanData_List[[2]], chains = 4, iter = 1000, cores = 4, seed = 123)
ModFentonPerkins_2_DO_Stoch_4_SHORT_Fit <- sampling(model, data = ModFentonPerkins_2_DO_Stoch_SHORT_StanData_List[[3]], chains = 4, iter = 1000, cores = 4, seed = 123)
ModFentonPerkins_2_DO_Stoch_5_SHORT_Fit <- sampling(model, data = ModFentonPerkins_2_DO_Stoch_SHORT_StanData_List[[4]], chains = 4, iter = 1000, cores = 4, seed = 123)

## Lotka-Volterra
BC_Stoch <- BC_Stoch_List[[1]]
...
LV_Long_Fit <- sampling(model, data = BC_StanData, iter = 1000, chains = 4, cores = 4, seed = 123)
```

### Summarising

```{r}
print(ModFentonPerkins_2_SLC_Stoch_2_SHORT_Fit, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"), probs = c(0.1, 0.5, 0.9), digits = 3)

print(ModFentonPerkins_2_DO_Stoch_2_SHORT_Fit, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"), probs = c(0.1, 0.5, 0.9), digits = 3)
print(ModFentonPerkins_2_DO_Stoch_3_SHORT_Fit, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"), probs = c(0.1, 0.5, 0.9), digits = 3)
print(ModFentonPerkins_2_DO_Stoch_4_SHORT_Fit, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"), probs = c(0.1, 0.5, 0.9), digits = 3)
print(ModFentonPerkins_2_DO_Stoch_5_SHORT_Fit, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"), probs = c(0.1, 0.5, 0.9), digits = 3)

print(LV_Long_Fit, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]"), probs = c(0.1, 0.5, 0.9), digits = 3)
```

# Troubleshooting: Re-Scaling Parameters of Fenton and Perkins (2010) Model
...
# }",
# "1_Models/StanUserGuide_Model.stan")
```
...
"1_Models/GitExample.stan")

## Compile model ##
model <- stan_model("1_Models/GitExample.stan")
...
"1_Models/Autoregressive_LogisticGrowth.stan")

model <- stan_model("1_Models/Autoregressive_LogisticGrowth.stan")
...
"1_Models/Autoregressive_TwoSp-LogisticGrowth.stan")

model <- stan_model("1_Models/Autoregressive_TwoSp-LogisticGrowth.stan")
...
# Two-Species: Modified Fenton and Perkins (2010)
...
"1_Models/Autoregressive_ModFentonPerkins.stan")

## Compile model ##
model <- stan_model("1_Models/Autoregressive_ModFentonPerkins.stan")
...
AR_DivO_B <- as.numeric(quantile(extract(fit, pars = "B")[[1]], probs = c(0.025, 0.5, 0.975)))
AR_DivO_h <- as.numeric(quantile(extract(fit, pars = "h")[[1]], probs = c(0.025, 0.5, 0.975)))
```
...
AR_SLC_B <- as.numeric(quantile(extract(fit, pars = "B")[[1]], probs = c(0.025, 0.5, 0.975)))
AR_SLC_h <- as.numeric(quantile(extract(fit, pars = "h")[[1]], probs = c(0.025, 0.5, 0.975)))
```
...
AR_DO_B <- as.numeric(quantile(extract(fit, pars = "B")[[1]], probs = c(0.025, 0.5, 0.975)))
AR_DO_h <- as.numeric(quantile(extract(fit, pars = "h")[[1]], probs = c(0.025, 0.5, 0.975)))
```

# 95% CIs 

```{r}
Model <- c("MFP_1", "MFP_2_DO", "MFP_2_SLC", "MFP_3")

## B
MFP_1.1_B <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj1, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.2_B <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj2, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.3_B <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj3, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.4_B <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj4, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.5_B <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj5, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))

MFP_2.1_DO_B <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj1, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.2_DO_B <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj2, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.3_DO_B <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj3, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.4_DO_B <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj4, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.5_DO_B <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj5, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))

MFP_2.1_SLC_B <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj1, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.2_SLC_B <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj2, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.3_SLC_B <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj3, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.4_SLC_B <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj4, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.5_SLC_B <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj5, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))

MFP_3.1_B <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj1, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.2_B <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj2, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.3_B <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj3, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.4_B <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj4, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.5_B <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj5, pars = "theta[2]")[[1]], probs = c(0.025, 0.5, 0.975)))
...
colours <- c(rep("red3", 5), rep("orange", 5), rep("forestgreen", 5), rep("orchid", 5))
...
## h
MFP_1.1_h <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj1, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.2_h <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj2, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.3_h <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj3, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.4_h <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj4, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_1.5_h <- as.numeric(quantile(extract(ModFentonPerkins_1_FitObj5, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))

MFP_2.1_DO_h <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj1, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.2_DO_h <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj2, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.3_DO_h <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj3, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.4_DO_h <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj4, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.5_DO_h <- as.numeric(quantile(extract(ModFentonPerkins_2_DO_FitObj5, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))

MFP_2.1_SLC_h <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj1, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.2_SLC_h <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj2, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.3_SLC_h <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj3, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.4_SLC_h <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj4, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_2.5_SLC_h <- as.numeric(quantile(extract(ModFentonPerkins_2_SLC_FitObj5, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))

MFP_3.1_h <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj1, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.2_h <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj2, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.3_h <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj3, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.4_h <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj4, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
MFP_3.5_h <- as.numeric(quantile(extract(ModFentonPerkins_3_FitObj5, pars = "theta[3]")[[1]], probs = c(0.025, 0.5, 0.975)))
...
ggplot(df.h, aes(x = Model, y = Mean, colour = colours)) + geom_point() +  
  geom_errorbar(aes(ymin = Lower, ymax = Upper)) +
  labs(y = "Mean Estimate of h") +
  ylim(0, 1) +
  theme_bw() +
  theme(axis.line = element_line(colour = "black"),
    panel.grid.major = element_blank(),
...
colours <- c("red3", "orchid", "purple4")

df.b <- data.frame(AR_DivO_B, AR_SLC_B, AR_DO_B)
df.b <- as.matrix(df.b); df.b <- t(df.b); df.b <- as.data.frame(df.b); colnames(df.b) <- c("Lower", "Mean", "Upper")
Model <- c(rownames(df.b)); df.b <- cbind(Model, df.b); df.b <- as.data.frame(df.b)

ggplot(df.b, aes(x = Model, y = Mean, colour = colours)) + 
  geom_point() +  
  geom_errorbar(aes(ymin = Lower, ymax = Upper)) +
  labs(y = "Mean Estimate of B") +
  ylim(0, 0.025) +
...
df.h <- data.frame(AR_DivO_h, AR_SLC_h, AR_DO_h)
df.h <- as.matrix(df.h); df.h <- t(df.h); df.h <- as.data.frame(df.h); colnames(df.h) <- c("Lower", "Mean", "Upper")
Model <- c(rownames(df.h)); df.h <- cbind(Model, df.h); df.h <- as.data.frame(df.h)

ggplot(df.h, aes(x = Model, y = Mean, colour = colours)) + 
  geom_point() +  
  geom_errorbar(aes(ymin = Lower, ymax = Upper)) +
  labs(y = "Mean Estimate of h") +
  ylim(0, 0.2) +
