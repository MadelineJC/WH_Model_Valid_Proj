...
Seeds <- c(1, 2, 3, 4, 5); ModFentonPerkins_SLC_Stoch_List <- list()
for (i in Seeds){
  set.seed(i)
  ModFentonPerkins_SLC_Stoch <- suppressWarnings(ssa(x0, a, nu, parms1, tf, method, simName,
                                    verbose = FALSE, 
                                    consoleInterval = 1, 
                                    censusInterval = 1, 
                                    maxWallTime = 30, 
                                    ignoreNegativeState = TRUE)) 
  ModFentonPerkins_SLC_Stoch <- ModFentonPerkins_SLC_Stoch$data; ModFentonPerkins_SLC_Stoch <- as.data.frame(ModFentonPerkins_SLC_Stoch)
  colnames(ModFentonPerkins_SLC_Stoch) <- c("Time", "P", "I")
  FirstZero <- which(ModFentonPerkins_SLC_Stoch$P == 0)[1]
  if (is.na(FirstZero)){
    ModFentonPerkins_SLC_Stoch_List[[i]] <- ModFentonPerkins_SLC_Stoch
  } else {
    ModFentonPerkins_SLC_Stoch <- ModFentonPerkins_SLC_Stoch[1:FirstZero - 1, ]
    ModFentonPerkins_SLC_Stoch_List[[i]] <- ModFentonPerkins_SLC_Stoch
  }
}
write.csv(ModFentonPerkins_SLC_Stoch_List[[1]], "0_Data/1_Stochastic/ModFentonPerkins_SLC_Stoch_1.csv")
write.csv(ModFentonPerkins_SLC_Stoch_List[[2]], "0_Data/1_Stochastic/ModFentonPerkins_SLC_Stoch_2.csv")
write.csv(ModFentonPerkins_SLC_Stoch_List[[3]], "0_Data/1_Stochastic/ModFentonPerkins_SLC_Stoch_3.csv")
write.csv(ModFentonPerkins_SLC_Stoch_List[[4]], "0_Data/1_Stochastic/ModFentonPerkins_SLC_Stoch_4.csv")
write.csv(ModFentonPerkins_SLC_Stoch_List[[5]], "0_Data/1_Stochastic/ModFentonPerkins_SLC_Stoch_5.csv")

plot(ModFentonPerkins_SLC_Stoch_List[[1]]$Time, ModFentonPerkins_SLC_Stoch_List[[1]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (1)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_SLC_Stoch_List[[1]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_SLC_Stoch_List[[1]]$Time, ModFentonPerkins_SLC_Stoch_List[[1]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_SLC_Stoch_List[[2]]$Time, ModFentonPerkins_SLC_Stoch_List[[2]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (2)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_SLC_Stoch_List[[2]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_SLC_Stoch_List[[2]]$Time, ModFentonPerkins_SLC_Stoch_List[[2]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_SLC_Stoch_List[[3]]$Time, ModFentonPerkins_SLC_Stoch_List[[3]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (3)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_SLC_Stoch_List[[3]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_SLC_Stoch_List[[3]]$Time, ModFentonPerkins_SLC_Stoch_List[[3]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_SLC_Stoch_List[[4]]$Time, ModFentonPerkins_SLC_Stoch_List[[4]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (5)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_SLC_Stoch_List[[4]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_SLC_Stoch_List[[4]]$Time, ModFentonPerkins_SLC_Stoch_List[[4]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_SLC_Stoch_List[[5]]$Time, ModFentonPerkins_SLC_Stoch_List[[5]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (5)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_SLC_Stoch_List[[5]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_SLC_Stoch_List[[5]]$Time, ModFentonPerkins_SLC_Stoch_List[[5]]$I, col = "cornflowerblue", lwd = 2)
```
...
Seeds <- c(1, 2, 3, 4, 5); ModFentonPerkins_DO_Stoch_List <- list()
for (i in Seeds){
  set.seed(i)
  ModFentonPerkins_DO_Stoch <- suppressWarnings(ssa(x0, a, nu, parms1, tf, method, simName,
                                    verbose = FALSE, 
                                    consoleInterval = 1, 
                                    censusInterval = 1, 
                                    maxWallTime = 30, 
                                    ignoreNegativeState = TRUE)) 
  ModFentonPerkins_DO_Stoch <- ModFentonPerkins_DO_Stoch$data; ModFentonPerkins_DO_Stoch <- as.data.frame(ModFentonPerkins_DO_Stoch)
  colnames(ModFentonPerkins_DO_Stoch) <- c("Time", "P", "I")
  FirstZero <- which(ModFentonPerkins_DO_Stoch$P == 0)[1]
  if (is.na(FirstZero)){
    ModFentonPerkins_DO_Stoch_List[[i]] <- ModFentonPerkins_DO_Stoch
  } else {
    ModFentonPerkins_DO_Stoch <- ModFentonPerkins_DO_Stoch[1:FirstZero - 1, ]
    ModFentonPerkins_DO_Stoch_List[[i]] <- ModFentonPerkins_DO_Stoch
  }
}
write.csv(ModFentonPerkins_DO_Stoch_List[[1]], "0_Data/1_Stochastic/ModFentonPerkins_DO_Stoch_1.csv")
write.csv(ModFentonPerkins_DO_Stoch_List[[2]], "0_Data/1_Stochastic/ModFentonPerkins_DO_Stoch_2.csv")
write.csv(ModFentonPerkins_DO_Stoch_List[[3]], "0_Data/1_Stochastic/ModFentonPerkins_DO_Stoch_3.csv")
write.csv(ModFentonPerkins_DO_Stoch_List[[4]], "0_Data/1_Stochastic/ModFentonPerkins_DO_Stoch_4.csv")
write.csv(ModFentonPerkins_DO_Stoch_List[[5]], "0_Data/1_Stochastic/ModFentonPerkins_DO_Stoch_5.csv")

plot(ModFentonPerkins_DO_Stoch_List[[1]]$Time, ModFentonPerkins_DO_Stoch_List[[1]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (1)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_DO_Stoch_List[[1]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_DO_Stoch_List[[1]]$Time, ModFentonPerkins_DO_Stoch_List[[1]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_DO_Stoch_List[[2]]$Time, ModFentonPerkins_DO_Stoch_List[[2]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (2)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_DO_Stoch_List[[2]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_DO_Stoch_List[[2]]$Time, ModFentonPerkins_DO_Stoch_List[[2]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_DO_Stoch_List[[3]]$Time, ModFentonPerkins_DO_Stoch_List[[3]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (3)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_DO_Stoch_List[[3]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_DO_Stoch_List[[3]]$Time, ModFentonPerkins_DO_Stoch_List[[3]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_DO_Stoch_List[[4]]$Time, ModFentonPerkins_DO_Stoch_List[[4]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (5)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_DO_Stoch_List[[4]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_DO_Stoch_List[[4]]$Time, ModFentonPerkins_DO_Stoch_List[[4]]$I, col = "cornflowerblue", lwd = 2)

plot(ModFentonPerkins_DO_Stoch_List[[5]]$Time, ModFentonPerkins_DO_Stoch_List[[5]]$P, type = "l", main = "Stochastic Simulation of Mod. Fenton and Perkins (2010) Model (5)", xlab = "Time", ylab = "Population Abundance", ylim = c(0, max(ModFentonPerkins_DO_Stoch_List[[5]]$I)), col = "forestgreen", lwd = 2)
lines(ModFentonPerkins_DO_Stoch_List[[5]]$Time, ModFentonPerkins_DO_Stoch_List[[5]]$I, col = "cornflowerblue", lwd = 2)
```
...
```{r}
ModFentonPerkins_SLC_StanData_List <- list()
for (i in Seeds){
  ModFentonPerkins_SLC_Stoch <- ModFentonPerkins_SLC_Stoch_List[[i]]
  N <- length(ModFentonPerkins_SLC_Stoch$Time) - 1
  ts <- 1:N
  y_init <- c(ModFentonPerkins_SLC_Stoch$P[1], ModFentonPerkins_SLC_Stoch$I[1])
  y <- as.matrix(ModFentonPerkins_SLC_Stoch[2:(N + 1), 2:3])
  y <- cbind(y[ , 1], y[ , 2]); 
  ModFentonPerkins_SLC_StanData <- list(N = N, ts = ts, y_init = y_init, y = y)
  ModFentonPerkins_SLC_StanData_List[[i]] <- ModFentonPerkins_SLC_StanData
}
saveRDS(ModFentonPerkins_SLC_StanData_List, "0_Data/2_Stan/ModFentonPerkins_SLC_StanData_List.rds")
```
...
```{r}
fit <- sampling(model, data = ModFentonPerkins_SLC_StanData_List[[1]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_SLC_FitObj_1.rds")

fit <- sampling(model, data = ModFentonPerkins_SLC_StanData_List[[2]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_SLC_FitObj_2.rds")

fit <- sampling(model, data = ModFentonPerkins_SLC_StanData_List[[3]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_SLC_FitObj_3.rds")

fit <- sampling(model, data = ModFentonPerkins_SLC_StanData_List[[4]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_SLC_FitObj_4.rds")

fit <- sampling(model, data = ModFentonPerkins_SLC_StanData_List[[5]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_SLC_FitObj_5.rds")
```
...
```{r}
ModFentonPerkins_DO_StanData_List <- list()
for (i in Seeds){
  ModFentonPerkins_DO_Stoch <- ModFentonPerkins_DO_Stoch_List[[i]]
  N <- length(ModFentonPerkins_DO_Stoch$Time) - 1
  ts <- 1:N
  y_init <- c(ModFentonPerkins_DO_Stoch$P[1], ModFentonPerkins_DO_Stoch$I[1])
  y <- as.matrix(ModFentonPerkins_DO_Stoch[2:(N + 1), 2:3])
  y <- cbind(y[ , 1], y[ , 2]); 
  ModFentonPerkins_DO_StanData <- list(N = N, ts = ts, y_init = y_init, y = y)
  ModFentonPerkins_DO_StanData_List[[i]] <- ModFentonPerkins_DO_StanData
}
saveRDS(ModFentonPerkins_DO_StanData_List, "0_Data/2_Stan/ModFentonPerkins_DO_StanData_List.rds")
```
...
```{r}
fit <- sampling(model, data = ModFentonPerkins_DO_StanData_List[[1]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_DO_FitObj_1.rds")

fit <- sampling(model, data = ModFentonPerkins_DO_StanData_List[[2]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_DO_FitObj_2.rds")

fit <- sampling(model, data = ModFentonPerkins_DO_StanData_List[[3]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_DO_FitObj_3.rds")

fit <- sampling(model, data = ModFentonPerkins_DO_StanData_List[[4]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_DO_FitObj_4.rds")

fit <- sampling(model, data = ModFentonPerkins_DO_StanData_List[[5]], chains = 4, iter = 2000, cores = 4, seed = 123)
saveRDS(fit, file = "2_FitObjects/ModFentonPerkins_DO_FitObj_5.rds")
```
