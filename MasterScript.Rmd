...
saveRDS(Antia_Stoch_List, "0_Data/1_Stochastic/Antia_Stoch_Continuous.rds")
...
saveRDS(ModFentonPerkins_1_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Continuous.rds")
...
saveRDS(ModFentonPerkins_2_DivOsc_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Continuous.rds")
...
saveRDS(ModFentonPerkins_2_SLC_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Continuous.rds")
...
saveRDS(ModFentonPerkins_2_DO_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Continuous.rds")
...
saveRDS(ModFentonPerkins_3_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Continuous.rds")
...
saveRDS(Antia_Stoch_List, "0_Data/1_Stochastic/Antia_Stoch_Discrete.rds")
...
saveRDS(ModFentonPerkins_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Discrete.rds")
...
saveRDS(ModFentonPerkins_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Discrete.rds")
...
saveRDS(ModFentonPerkins_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Discrete.rds")
...
saveRDS(ModFentonPerkins_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Discrete.rds")
...
saveRDS(ModFentonPerkins_Stoch_List, "0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Discrete.rds")
...
# FITTING MODELS TO MIS-MATCHED DATA

## Global Framework

```{r}
Antia_Stoch_List <- readRDS("0_Data/1_Stochastic/Antia_Stoch_Continuous.rds") # 1-5
ModFentonPerkins_1_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Continuous.rds") # 6-10
ModFentonPerkins_2_DO_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Continuous.rds") # 11-15
ModFentonPerkins_2_SLC_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Continuous.rds") # 16-20
ModFentonPerkins_2_DivOsc_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Continuous.rds") # 21-25
ModFentonPerkins_3_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Continuous.rds") # 26-30

All_Stoch_List <- c(Antia_Stoch_List, ModFentonPerkins_1_Stoch_List, ModFentonPerkins_2_DO_Stoch_List, ModFentonPerkins_2_SLC_Stoch_List, ModFentonPerkins_2_DivOsc_Stoch_List, ModFentonPerkins_3_Stoch_List)

StanData_List <- list()
for (i in 1:length(All_Stoch_List)){
  Stoch <- All_Stoch_List[[i]]
  N <- length(Stoch$Time) - 1
  ts <- 1:N
  y_init <- c(Stoch$P[1], Stoch$I[1])
  y <- as.matrix(Stoch[2:(N + 1), 2:3])
  y <- cbind(y[ , 1], y[ , 2]); 
  MisMatchedData_StanData <- list(N = N, ts = ts, y_init = y_init, y = y)
  StanData_List[[i]] <- MisMatchedData_StanData
}

Antia_Model <- stan_model("1_Models/Antia.stan")
MFP_I_Model <- stan_model("1_Models/FP_1_AllParms.stan")
MFP_II_Model <- stan_model("1_Models/FP_2_AllParms.stan")
MFP_III_Model <- stan_model("1_Models/FP_3_AllParms.stan")

# Fit Antia model to all other data
AntiaModel_StanData_List <- StanData_List[c(6:30)]
AntiaModel_MisMatch_G <- list()
for(i in 1:length(AntiaModel_StanData_List)){
  Fit <- sampling(Antia_Model, data = AntiaModel_StanData_List[[i]], chains = 4, iter = 2000, cores = 4, seed = 123)
  AntiaModel_MisMatch_G[[i]] <- Fit
}
saveRDS(AntiaModel_MisMatch_G, "2_FitObjects/MismatchedFits/MisMatchedFits_AntiaModel_G_FullCross.rds")

# Fit MFP 1 model to all other data
MFP1Model_StanData_List <- StanData_List[c(1:5, 11:30)] # Antia, MFP2 (DO, SLC, DivOsc), MFP3
MFP1Model_MisMatch_G <- list()
for(i in 1:length(MFP1Model_StanData_List)){
  Fit <- sampling(MFP_I_Model, data = MFP1Model_StanData_List[[i]], chains = 4, iter = 2000, cores = 4, seed = 123)
  MFP1Model_MisMatch_G[[i]] <- Fit
}
saveRDS(MFP1Model_MisMatch_G, "2_FitObjects/MismatchedFits/MisMatchedFits_MFP1Model_G_FullCross.rds")

# Fit MFP 2 model to all other data
MFP2Model_StanData_List <- StanData_List[c(1:10, 26:30)] # Antia, MFP1, MFP3
MFP2Model_MisMatch_G <- list()
for(i in 1:length(MFP2Model_StanData_List)){
  Fit <- sampling(MFP_II_Model, data = MFP2Model_StanData_List[[i]], chains = 4, iter = 2000, cores = 4, seed = 123)
  MFP2Model_MisMatch_G[[i]] <- Fit
}
saveRDS(MFP2Model_MisMatch_G, "2_FitObjects/MismatchedFits/MisMatchedFits_MFP2Model_G_FullCross.rds")

# Fit MFP 3 model to all other data
MFP3Model_StanData_List <- StanData_List[c(1:25)] # Antia, MFP1, MFP2 (DO, SLC, DivOsc)
MFP3Model_MisMatch_G <- list()
for(i in 1:length(MFP3Model_StanData_List)){
  Fit <- sampling(MFP_III_Model, data = MFP3Model_StanData_List[[i]], chains = 4, iter = 2000, cores = 4, seed = 123)
  MFP3Model_MisMatch_G[[i]] <- Fit
}
saveRDS(MFP3Model_MisMatch_G, "2_FitObjects/MismatchedFits/MisMatchedFits_MFP3Model_G_FullCross.rds")
...
```{r}
Antia_Stoch_List <- readRDS("0_Data/1_Stochastic/Antia_Stoch_Discrete.rds") # 1-5
ModFentonPerkins_1_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Discrete.rds") # 6-10
ModFentonPerkins_2_DO_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Discrete.rds") # 11-15
ModFentonPerkins_2_SLC_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Discrete.rds") # 16-20
ModFentonPerkins_2_DivOsc_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Discrete.rds") # 21-25
ModFentonPerkins_3_Stoch_List <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Discrete.rds") # 26-30
...
for (i in 1:length(All_Stoch_List)){
  ...
  P_init <- c(Stoch$P[1])
  I_init <- c(Stoch$I[1])
  P <- as.vector(Stoch[2:(N + 1), 2:2])
  I <- as.vector(Stoch[2:(N + 1), 3:3])
  MisMatchedData_StanData <- list(N = N, ts = ts, P_init = P_init, I_init = I_init, P = P, I = I)
  StanData_List[[i]] <- MisMatchedData_StanData
}

Antia_Model <- stan_model("1_Models/Autoregressive_Antia.stan")
MFP_I_Model <- stan_model("1_Models/Autoregressive_ModFentonPerkins_1.stan")
MFP_II_Model <- stan_model("1_Models/Autoregressive_ModFentonPerkins_2.stan")
MFP_III_Model <- stan_model("1_Models/Autoregressive_ModFentonPerkins_3.stan")

# Fit Antia model to all other data
AntiaModel_StanData_List <- StanData_List[c(6:30)]
AntiaModel_MisMatch_AR <- list()
for(i in 1:length(AntiaModel_StanData_List)){
  Fit <- sampling(Antia_Model, data = AntiaModel_StanData_List[[i]], chains = 4, iter = 10000, cores = 4, seed = 123)
  AntiaModel_MisMatch_AR[[i]] <- Fit
}
saveRDS(AntiaModel_MisMatch_AR, "2_FitObjects/MismatchedFits/MisMatchedFits_AntiaModel_AR_FullCross.rds")

# Fit MFP 1 model to all other data
MFP1Model_StanData_List <- StanData_List[c(1:5, 11:30)] 
MFP1Model_MisMatch_AR <- list()
for(i in 1:length(MFP1Model_StanData_List)){
  Fit <- sampling(MFP_I_Model, data = MFP1Model_StanData_List[[i]], chains = 4, iter = 10000, cores = 4, seed = 123)
  MFP1Model_MisMatch_AR[[i]] <- Fit
}
saveRDS(MFP1Model_MisMatch_AR, "2_FitObjects/MismatchedFits/MisMatchedFits_MFP1Model_AR_FullCross.rds")

# Fit MFP 2 model to all other data
MFP2Model_StanData_List <- StanData_List[c(1:10, 26:30)] 
MFP2Model_MisMatch_AR <- list()
for(i in 1:length(MFP2Model_StanData_List)){
  Fit <- sampling(MFP_II_Model, data = MFP2Model_StanData_List[[i]], chains = 4, iter = 10000, cores = 4, seed = 123)
  MFP2Model_MisMatch_AR[[i]] <- Fit
}
saveRDS(MFP2Model_MisMatch_AR, "2_FitObjects/MismatchedFits/MisMatchedFits_MFP2Model_AR_FullCross.rds")

# Fit MFP 3 model to all other data
MFP3Model_StanData_List <- StanData_List[c(1:25)] 
MFP3Model_MisMatch_AR <- list()
for(i in 1:length(MFP3Model_StanData_List)){
  Fit <- sampling(MFP_III_Model, data = MFP3Model_StanData_List[[i]], chains = 4, iter = 10000, cores = 4, seed = 123)
  MFP3Model_MisMatch_AR[[i]] <- Fit
}
saveRDS(MFP3Model_MisMatch_AR, "2_FitObjects/MismatchedFits/MisMatchedFits_MFP3Model_AR_FullCross.rds")
```

## Convergence Assessment

```{r}
# Convergence: Antia, Global
for(i in 1:5){
  print(AntiaModel_MisMatch_G[[i]], pars = c("r", "k", "p", "o"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
} # T1: 2 (2, 3)
...
# Convergence: MFP1, Global
for(i in 1:5){
  print(MFP1Model_MisMatch_G[[i]], pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
} # A: 5 (ALL)
...
# Convergence: MFP2, Global
for(i in 1:5){
  print(MFP2Model_MisMatch_G[[i]], pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
} # A: 4 (1, 3, 4, 5)
...
# Convergence: MFP3, Global
for(i in 1:5){
  print(MFP3Model_MisMatch_G[[i]], pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
} # A: 3 (2, 4, 5)
...
# Convergence: Antia, AR
for (i in 1:length(AntiaModel_MisMatch_AR)){
  print(AntiaModel_MisMatch_AR[[i]], pars = c("r", "k", "p", "o"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
}

# Convergence: MFP1, AR
for (i in 1:length(MFP1Model_MisMatch_AR)){
  print(MFP1Model_MisMatch_AR[[i]], pars = c("r", "B", "b", "e", "delta"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
}

# Convergence: MFP2, AR
for (i in 1:length(MFP2Model_MisMatch_AR)){
  print(MFP2Model_MisMatch_AR[[i]], pars = c("r", "B", "h", "b", "e", "delta"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
}

# Convergence: MFP3, AR
for (i in 1:length(MFP3Model_MisMatch_AR)){
  print(MFP3Model_MisMatch_AR[[i]], pars = c("r", "B", "h", "b", "e", "delta"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
}
```

Global Fitting, Full Cross

+---------------+----------------+-------------+-----------------------+-------------------+----------------------+--------------+
|               | Antia Data     | MFP I Data  | MFP II (DampOsc) Data | MFP II (SLC) Data | MFP II (DivOsc) Data | MFP III Data |
+---------------+----------------+-------------+-----------------------+-------------------+----------------------+--------------+
| Antia Model   | **5**          | 2 (2, 3)    | 1 (1)                 | 4 (2, 3, 4, 5)    | 3 (1, 3, 4)          | 1 (5)        |
+---------------+----------------+-------------+-----------------------+-------------------+----------------------+--------------+
| MFP I Model   | 5 (1-5)        | **4**       | 5 (1-5)               | 4 (1, 2, 3, 5)    | 4 (1, 2, 3, 5)       | 5 (1-5)      |
+---------------+----------------+-------------+-----------------------+-------------------+----------------------+--------------+
| MFP II Model  | 4 (1, 3, 4, 5) | 3 (1, 3, 5) | **2**                 | **3**             | **2**                | 2 (3, 5)     |
+---------------+----------------+-------------+-----------------------+-------------------+----------------------+--------------+
| MFP III Model | 3 (2, 4, 5)    | 0           | 0                     | 0                 | 0                    | **4**        |
+---------------+----------------+-------------+-----------------------+-------------------+----------------------+--------------+

AR Fitting, Full Cross

+---------------+-------------+------------+-----------------------+-------------------+----------------------+--------------+
|               | Antia Data  | MFP I Data | MFP II (DampOsc) Data | MFP II (SLC) Data | MFP II (DivOsc) Data | MFP III Data |
+---------------+-------------+------------+-----------------------+-------------------+----------------------+--------------+
| Antia Model   | **5**       | 5 (1-5)    | 1 (4)                 | 1 (1)             | 0                    | 3 (2, 3, 5)  |
+---------------+-------------+------------+-----------------------+-------------------+----------------------+--------------+
| MFP I Model   | 3 (2, 3, 4) | **5**      | 0                     | 0                 | 0                    | 0            |
+---------------+-------------+------------+-----------------------+-------------------+----------------------+--------------+
| MFP II Model  | 5 (1-5)     | 0          | **5**                 | **5**             | **5**                | 5 (1-5)      |
+---------------+-------------+------------+-----------------------+-------------------+----------------------+--------------+
| MFP III Model | 5 (1-5)     | 0          | 5 (1-5)               | 5 (1-5)           | 5 (1-5)              | **5**        |
+---------------+-------------+------------+-----------------------+-------------------+----------------------+--------------+
...
```{r}
## Pulling Posterior
Output.MFP1.TS2 <- rstan::extract(AntiaModel_MisMatch_G[["T1.2"]], permuted = TRUE, include = TRUE)
Output.MFP1.TS3 <- rstan::extract(AntiaModel_MisMatch_G[["T1.2"]], permuted = TRUE, include = TRUE)
Output.MFP2.DO.TS1 <- rstan::extract(AntiaModel_MisMatch_G[["T2.DO.1"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS2 <- rstan::extract(AntiaModel_MisMatch_G[["T2.SLC.2"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS3 <- rstan::extract(AntiaModel_MisMatch_G[["T2.SLC.3"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS4 <- rstan::extract(AntiaModel_MisMatch_G[["T2.SLC.4"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS5 <- rstan::extract(AntiaModel_MisMatch_G[["T2.SLC.5"]], permuted = TRUE, include = TRUE)
Output.MFP2.DivOsc.TS1 <- rstan::extract(AntiaModel_MisMatch_G[["T2.DivOsc.1"]], permuted = TRUE, include = TRUE)
Output.MFP2.DivOsc.TS3 <- rstan::extract(AntiaModel_MisMatch_G[["T2.DivOsc.3"]], permuted = TRUE, include = TRUE)
Output.MFP2.DivOsc.TS4 <- rstan::extract(AntiaModel_MisMatch_G[["T2.DivOsc.4"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS5 <- rstan::extract(AntiaModel_MisMatch_G[["T3.5"]], permuted = TRUE, include = TRUE)

## Wrangling 2
Est.MFP1.TS2 <- data.frame(Output.MFP1.TS2$y_rep); Est.Means.MFP1.TS2 <- Est.MFP1.TS2 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP1.TS3 <- data.frame(Output.MFP1.TS3$y_rep); Est.Means.MFP1.TS3 <- Est.MFP1.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DO.TS1 <- data.frame(Output.MFP2.DO.TS1$y_rep); Est.Means.MFP2.DO.TS1 <- Est.MFP2.DO.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS2 <- data.frame(Output.MFP2.SLC.TS2$y_rep); Est.Means.MFP2.SLC.TS2 <- Est.MFP2.SLC.TS2 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS3 <- data.frame(Output.MFP2.SLC.TS3$y_rep); Est.Means.MFP2.SLC.TS3 <- Est.MFP2.SLC.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS4 <- data.frame(Output.MFP2.SLC.TS4$y_rep); Est.Means.MFP2.SLC.TS4 <- Est.MFP2.SLC.TS4 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS5 <- data.frame(Output.MFP2.SLC.TS5$y_rep); Est.Means.MFP2.SLC.TS5 <- Est.MFP2.SLC.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DivOsc.TS1 <- data.frame(Output.MFP2.DivOsc.TS1$y_rep); Est.Means.MFP2.DivOsc.TS1 <- Est.MFP2.DivOsc.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DivOsc.TS3 <- data.frame(Output.MFP2.DivOsc.TS3$y_rep); Est.Means.MFP2.DivOsc.TS3 <- Est.MFP2.DivOsc.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DivOsc.TS4 <- data.frame(Output.MFP2.DivOsc.TS4$y_rep); Est.Means.MFP2.DivOsc.TS4 <- Est.MFP2.DivOsc.TS4 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS5 <- data.frame(Output.MFP3.TS5$y_rep); Est.Means.MFP3.TS5 <- Est.MFP3.TS5 %>% summarise(across(.cols = everything(), .fns = mean))

## Wrangling 2
x <- ncol(Est.Means.MFP1.TS2)/2
Est.Means.MFP1.TS2.P <- Est.Means.MFP1.TS2[-c(x + 1:ncol(Est.Means.MFP1.TS2))]; Est.Means.MFP1.TS2.I <- Est.Means.MFP1.TS2[-c(1:x)]
Est.Means.MFP1.TS2.P <- t(Est.Means.MFP1.TS2.P); Est.Means.MFP1.TS2.I <- t(Est.Means.MFP1.TS2.I)

x <- ncol(Est.Means.MFP1.TS3)/2
Est.Means.MFP1.TS3.P <- Est.Means.MFP1.TS3[-c(x + 1:ncol(Est.Means.MFP1.TS3))]; Est.Means.MFP1.TS3.I <- Est.Means.MFP1.TS3[-c(1:x)]
Est.Means.MFP1.TS3.P <- t(Est.Means.MFP1.TS3.P); Est.Means.MFP1.TS3.I <- t(Est.Means.MFP1.TS3.I)

x <- ncol(Est.Means.MFP2.DO.TS1)/2
Est.Means.MFP2.DO.TS1.P <- Est.Means.MFP2.DO.TS1[-c(x + 1:ncol(Est.Means.MFP2.DO.TS1))]; Est.Means.MFP2.DO.TS1.I <- Est.Means.MFP2.DO.TS1[-c(1:x)]
Est.Means.MFP2.DO.TS1.P <- t(Est.Means.MFP2.DO.TS1.P); Est.Means.MFP2.DO.TS1.I <- t(Est.Means.MFP2.DO.TS1.I)

x <- ncol(Est.Means.MFP2.SLC.TS2)/2
Est.Means.MFP2.SLC.TS2.P <- Est.Means.MFP2.SLC.TS2[-c(x + 1:ncol(Est.Means.MFP2.SLC.TS2))]; Est.Means.MFP2.SLC.TS2.I <- Est.Means.MFP2.SLC.TS2[-c(1:x)]
Est.Means.MFP2.SLC.TS2.P <- t(Est.Means.MFP2.SLC.TS2.P); Est.Means.MFP2.SLC.TS2.I <- t(Est.Means.MFP2.SLC.TS2.I)

x <- ncol(Est.Means.MFP2.SLC.TS3)/2
Est.Means.MFP2.SLC.TS3.P <- Est.Means.MFP2.SLC.TS3[-c(x + 1:ncol(Est.Means.MFP2.SLC.TS3))]; Est.Means.MFP2.SLC.TS3.I <- Est.Means.MFP2.SLC.TS3[-c(1:x)]
Est.Means.MFP2.SLC.TS3.P <- t(Est.Means.MFP2.SLC.TS3.P); Est.Means.MFP2.SLC.TS3.I <- t(Est.Means.MFP2.SLC.TS3.I)

x <- ncol(Est.Means.MFP2.SLC.TS4)/2
Est.Means.MFP2.SLC.TS4.P <- Est.Means.MFP2.SLC.TS4[-c(x + 1:ncol(Est.Means.MFP2.SLC.TS4))]; Est.Means.MFP2.SLC.TS4.I <- Est.Means.MFP2.SLC.TS4[-c(1:x)]
Est.Means.MFP2.SLC.TS4.P <- t(Est.Means.MFP2.SLC.TS4.P); Est.Means.MFP2.SLC.TS4.I <- t(Est.Means.MFP2.SLC.TS4.I)

x <- ncol(Est.Means.MFP2.SLC.TS5)/2
Est.Means.MFP2.SLC.TS5.P <- Est.Means.MFP2.SLC.TS5[-c(x + 1:ncol(Est.Means.MFP2.SLC.TS5))]; Est.Means.MFP2.SLC.TS5.I <- Est.Means.MFP2.SLC.TS5[-c(1:x)]
Est.Means.MFP2.SLC.TS5.P <- t(Est.Means.MFP2.SLC.TS5.P); Est.Means.MFP2.SLC.TS5.I <- t(Est.Means.MFP2.SLC.TS5.I)

x <- ncol(Est.Means.MFP2.DivOsc.TS1)/2
Est.Means.MFP2.DivOsc.TS1.P <- Est.Means.MFP2.DivOsc.TS1[-c(x + 1:ncol(Est.Means.MFP2.DivOsc.TS1))]; Est.Means.MFP2.DivOsc.TS1.I <- Est.Means.MFP2.DivOsc.TS1[-c(1:x)]
Est.Means.MFP2.DivOsc.TS1.P <- t(Est.Means.MFP2.DivOsc.TS1.P); Est.Means.MFP2.DivOsc.TS1.I <- t(Est.Means.MFP2.DivOsc.TS1.I)

x <- ncol(Est.Means.MFP2.DivOsc.TS3)/2
Est.Means.MFP2.DivOsc.TS3.P <- Est.Means.MFP2.DivOsc.TS3[-c(x + 1:ncol(Est.Means.MFP2.DivOsc.TS3))]; Est.Means.MFP2.DivOsc.TS3.I <- Est.Means.MFP2.DivOsc.TS3[-c(1:x)]
Est.Means.MFP2.DivOsc.TS3.P <- t(Est.Means.MFP2.DivOsc.TS3.P); Est.Means.MFP2.DivOsc.TS3.I <- t(Est.Means.MFP2.DivOsc.TS3.I)

x <- ncol(Est.Means.MFP2.DivOsc.TS4)/2
Est.Means.MFP2.DivOsc.TS4.P <- Est.Means.MFP2.DivOsc.TS4[-c(x + 1:ncol(Est.Means.MFP2.DivOsc.TS4))]; Est.Means.MFP2.DivOsc.TS4.I <- Est.Means.MFP2.DivOsc.TS4[-c(1:x)]
Est.Means.MFP2.DivOsc.TS4.P <- t(Est.Means.MFP2.DivOsc.TS4.P); Est.Means.MFP2.DivOsc.TS4.I <- t(Est.Means.MFP2.DivOsc.TS4.I)

x <- ncol(Est.Means.MFP3.TS5)/2
Est.Means.MFP3.TS5.P <- Est.Means.MFP3.TS5[-c(x + 1:ncol(Est.Means.MFP3.TS5))]; Est.Means.MFP3.TS5.I <- Est.Means.MFP3.TS5[-c(1:x)]
Est.Means.MFP3.TS5.P <- t(Est.Means.MFP3.TS5.P); Est.Means.MFP3.TS5.I <- t(Est.Means.MFP3.TS5.I)

## Plotting
MFP1.2.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_2.csv")
plot(x = 1:nrow(MFP1.2.Dat), y = MFP1.2.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 40000))
lines(x = 1:nrow(MFP1.2.Dat), y = MFP1.2.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP1.TS2.P), y = Est.Means.MFP1.TS2.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP1.TS2.I), y = Est.Means.MFP1.TS2.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP1.3.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_3.csv")
plot(x = 1:nrow(MFP1.3.Dat), y = MFP1.3.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 40000))
lines(x = 1:nrow(MFP1.3.Dat), y = MFP1.3.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP1.TS3.P), y = Est.Means.MFP1.TS3.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP1.TS3.I), y = Est.Means.MFP1.TS3.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.DO.1.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_1.csv")
plot(x = 1:nrow(MFP2.DO.1.Dat), y = MFP2.DO.1.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 500))
lines(x = 1:nrow(MFP2.DO.1.Dat), y = MFP2.DO.1.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS1.P), y = Est.Means.MFP2.DO.TS1.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS1.I), y = Est.Means.MFP2.DO.TS1.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.SLC.2.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_2.csv")
plot(x = 1:nrow(MFP2.SLC.2.Dat), y = MFP2.SLC.2.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 350))
lines(x = 1:nrow(MFP2.SLC.2.Dat), y = MFP2.SLC.2.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS2.P), y = Est.Means.MFP2.SLC.TS2.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS2.I), y = Est.Means.MFP2.SLC.TS2.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.SLC.3.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_3.csv")
plot(x = 1:nrow(MFP2.SLC.3.Dat), y = MFP2.SLC.3.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 300))
lines(x = 1:nrow(MFP2.SLC.3.Dat), y = MFP2.SLC.3.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS3.P), y = Est.Means.MFP2.SLC.TS3.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS3.I), y = Est.Means.MFP2.SLC.TS3.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.SLC.4.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_4.csv")
plot(x = 1:nrow(MFP2.SLC.4.Dat), y = MFP2.SLC.4.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 300))
lines(x = 1:nrow(MFP2.SLC.4.Dat), y = MFP2.SLC.4.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS4.P), y = Est.Means.MFP2.SLC.TS4.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS4.I), y = Est.Means.MFP2.SLC.TS4.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.SLC.5.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_5.csv")
plot(x = 1:nrow(MFP2.SLC.5.Dat), y = MFP2.SLC.5.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 300))
lines(x = 1:nrow(MFP2.SLC.5.Dat), y = MFP2.SLC.5.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS5.P), y = Est.Means.MFP2.SLC.TS5.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS5.I), y = Est.Means.MFP2.SLC.TS5.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.DivOsc.1.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_1.csv")
plot(x = 1:nrow(MFP2.DivOsc.1.Dat), y = MFP2.DivOsc.1.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 350))
lines(x = 1:nrow(MFP2.DivOsc.1.Dat), y = MFP2.DivOsc.1.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS1.P), y = Est.Means.MFP2.DivOsc.TS1.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS1.I), y = Est.Means.MFP2.DivOsc.TS1.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.DivOsc.3.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_3.csv")
plot(x = 1:nrow(MFP2.DivOsc.3.Dat), y = MFP2.DivOsc.3.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 300))
lines(x = 1:nrow(MFP2.DivOsc.3.Dat), y = MFP2.DivOsc.3.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS3.P), y = Est.Means.MFP2.DivOsc.TS3.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS3.I), y = Est.Means.MFP2.DivOsc.TS3.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.DivOsc.4.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_4.csv")
plot(x = 1:nrow(MFP2.DivOsc.4.Dat), y = MFP2.DivOsc.4.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 300))
lines(x = 1:nrow(MFP2.DivOsc.4.Dat), y = MFP2.DivOsc.4.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS4.P), y = Est.Means.MFP2.DivOsc.TS4.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS4.I), y = Est.Means.MFP2.DivOsc.TS4.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)
```
...
```{r}
## Pulling Posterior
Output.A.TS1 <- rstan::extract(MFP1Model_MisMatch_G[["A.1"]], permuted = TRUE, include = TRUE)
Output.A.TS2 <- rstan::extract(MFP1Model_MisMatch_G[["A.2"]], permuted = TRUE, include = TRUE)
Output.A.TS3 <- rstan::extract(MFP1Model_MisMatch_G[["A.3"]], permuted = TRUE, include = TRUE)
Output.A.TS4 <- rstan::extract(MFP1Model_MisMatch_G[["A.4"]], permuted = TRUE, include = TRUE)
Output.A.TS5 <- rstan::extract(MFP1Model_MisMatch_G[["A.5"]], permuted = TRUE, include = TRUE)
Output.MFP2.DO.TS1 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DO.1"]], permuted = TRUE, include = TRUE)
Output.MFP2.DO.TS2 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DO.2"]], permuted = TRUE, include = TRUE)
Output.MFP2.DO.TS3 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DO.3"]], permuted = TRUE, include = TRUE)
Output.MFP2.DO.TS4 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DO.4"]], permuted = TRUE, include = TRUE)
Output.MFP2.DO.TS5 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DO.5"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS1 <- rstan::extract(MFP1Model_MisMatch_G[["T2.SLC.1"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS2 <- rstan::extract(MFP1Model_MisMatch_G[["T2.SLC.2"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS3 <- rstan::extract(MFP1Model_MisMatch_G[["T2.SLC.3"]], permuted = TRUE, include = TRUE)
Output.MFP2.SLC.TS5 <- rstan::extract(MFP1Model_MisMatch_G[["T2.SLC.5"]], permuted = TRUE, include = TRUE)
Output.MFP2.DivOsc.TS1 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DivOsc.1"]], permuted = TRUE, include = TRUE)
Output.MFP2.DivOsc.TS2 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DivOsc.2"]], permuted = TRUE, include = TRUE)
Output.MFP2.DivOsc.TS3 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DivOsc.3"]], permuted = TRUE, include = TRUE)
Output.MFP2.DivOsc.TS5 <- rstan::extract(MFP1Model_MisMatch_G[["T2.DivOsc.5"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS1 <- rstan::extract(MFP1Model_MisMatch_G[["T3.1"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS2 <- rstan::extract(MFP1Model_MisMatch_G[["T3.2"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS3 <- rstan::extract(MFP1Model_MisMatch_G[["T3.3"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS4 <- rstan::extract(MFP1Model_MisMatch_G[["T3.4"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS5 <- rstan::extract(MFP1Model_MisMatch_G[["T3.5"]], permuted = TRUE, include = TRUE)

## Wrangling 2
Est.A.TS1 <- data.frame(Output.A.TS1$y_rep); Est.Means.A.TS1 <- Est.A.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.A.TS2 <- data.frame(Output.A.TS2$y_rep); Est.Means.A.TS2 <- Est.A.TS2 %>% summarise(across(.cols = everything(), .fns = mean))
Est.A.TS3 <- data.frame(Output.A.TS3$y_rep); Est.Means.A.TS3 <- Est.A.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.A.TS4 <- data.frame(Output.A.TS4$y_rep); Est.Means.A.TS4 <- Est.A.TS4 %>% summarise(across(.cols = everything(), .fns = mean))
Est.A.TS5 <- data.frame(Output.A.TS5$y_rep); Est.Means.A.TS5 <- Est.A.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DO.TS1 <- data.frame(Output.MFP2.DO.TS1$y_rep); Est.Means.MFP2.DO.TS1 <- Est.MFP2.DO.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DO.TS2 <- data.frame(Output.MFP2.DO.TS2$y_rep); Est.Means.MFP2.DO.TS2 <- Est.MFP2.DO.TS2 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DO.TS3 <- data.frame(Output.MFP2.DO.TS3$y_rep); Est.Means.MFP2.DO.TS3 <- Est.MFP2.DO.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DO.TS4 <- data.frame(Output.MFP2.DO.TS4$y_rep); Est.Means.MFP2.DO.TS4 <- Est.MFP2.DO.TS4 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DO.TS5 <- data.frame(Output.MFP2.DO.TS5$y_rep); Est.Means.MFP2.DO.TS5 <- Est.MFP2.DO.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS1 <- data.frame(Output.MFP2.SLC.TS1$y_rep); Est.Means.MFP2.SLC.TS1 <- Est.MFP2.SLC.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS2 <- data.frame(Output.MFP2.SLC.TS2$y_rep); Est.Means.MFP2.SLC.TS2 <- Est.MFP2.SLC.TS2 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS3 <- data.frame(Output.MFP2.SLC.TS3$y_rep); Est.Means.MFP2.SLC.TS3 <- Est.MFP2.SLC.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.SLC.TS5 <- data.frame(Output.MFP2.SLC.TS5$y_rep); Est.Means.MFP2.SLC.TS5 <- Est.MFP2.SLC.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DivOsc.TS1 <- data.frame(Output.MFP2.DivOsc.TS1$y_rep); Est.Means.MFP2.DivOsc.TS1 <- Est.MFP2.DivOsc.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DivOsc.TS2 <- data.frame(Output.MFP2.DivOsc.TS2$y_rep); Est.Means.MFP2.DivOsc.TS2 <- Est.MFP2.DivOsc.TS2 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DivOsc.TS3 <- data.frame(Output.MFP2.DivOsc.TS3$y_rep); Est.Means.MFP2.DivOsc.TS3 <- Est.MFP2.DivOsc.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP2.DivOsc.TS5 <- data.frame(Output.MFP2.DivOsc.TS5$y_rep); Est.Means.MFP2.DivOsc.TS5 <- Est.MFP2.DivOsc.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS1 <- data.frame(Output.MFP3.TS1$y_rep); Est.Means.MFP3.TS1 <- Est.MFP3.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS2 <- data.frame(Output.MFP3.TS2$y_rep); Est.Means.MFP3.TS2 <- Est.MFP3.TS2 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS3 <- data.frame(Output.MFP3.TS3$y_rep); Est.Means.MFP3.TS3 <- Est.MFP3.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS4 <- data.frame(Output.MFP3.TS4$y_rep); Est.Means.MFP3.TS4 <- Est.MFP3.TS4 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS5 <- data.frame(Output.MFP3.TS5$y_rep); Est.Means.MFP3.TS5 <- Est.MFP3.TS5 %>% summarise(across(.cols = everything(), .fns = mean))

## Wrangling 2
x <- ncol(Est.Means.A.TS1)/2
Est.Means.A.TS1.P <- Est.Means.A.TS1[-c(x + 1:ncol(Est.Means.A.TS1))]; Est.Means.A.TS1.I <- Est.Means.A.TS1[-c(1:x)]
Est.Means.A.TS1.P <- t(Est.Means.A.TS1.P); Est.Means.A.TS1.I <- t(Est.Means.A.TS1.I)

x <- ncol(Est.Means.A.TS2)/2
Est.Means.A.TS2.P <- Est.Means.A.TS2[-c(x + 1:ncol(Est.Means.A.TS2))]; Est.Means.A.TS2.I <- Est.Means.A.TS2[-c(1:x)]
Est.Means.A.TS2.P <- t(Est.Means.A.TS2.P); Est.Means.A.TS2.I <- t(Est.Means.A.TS2.I)

x <- ncol(Est.Means.A.TS3)/2
Est.Means.A.TS3.P <- Est.Means.A.TS3[-c(x + 1:ncol(Est.Means.A.TS3))]; Est.Means.A.TS3.I <- Est.Means.A.TS3[-c(1:x)]
Est.Means.A.TS3.P <- t(Est.Means.A.TS3.P); Est.Means.A.TS3.I <- t(Est.Means.A.TS3.I)

x <- ncol(Est.Means.A.TS4)/2
Est.Means.A.TS4.P <- Est.Means.A.TS4[-c(x + 1:ncol(Est.Means.A.TS4))]; Est.Means.A.TS4.I <- Est.Means.A.TS4[-c(1:x)]
Est.Means.A.TS4.P <- t(Est.Means.A.TS4.P); Est.Means.A.TS4.I <- t(Est.Means.A.TS4.I)

x <- ncol(Est.Means.A.TS5)/2
Est.Means.A.TS5.P <- Est.Means.A.TS5[-c(x + 1:ncol(Est.Means.A.TS5))]; Est.Means.A.TS5.I <- Est.Means.A.TS5[-c(1:x)]
Est.Means.A.TS5.P <- t(Est.Means.A.TS5.P); Est.Means.A.TS5.I <- t(Est.Means.A.TS5.I)

x <- ncol(Est.Means.MFP2.DO.TS1)/2
Est.Means.MFP2.DO.TS1.P <- Est.Means.MFP2.DO.TS1[-c(x + 1:ncol(Est.Means.MFP2.DO.TS1))]; Est.Means.MFP2.DO.TS1.I <- Est.Means.MFP2.DO.TS1[-c(1:x)]
Est.Means.MFP2.DO.TS1.P <- t(Est.Means.MFP2.DO.TS1.P); Est.Means.MFP2.DO.TS1.I <- t(Est.Means.MFP2.DO.TS1.I)

x <- ncol(Est.Means.MFP2.DO.TS2)/2
Est.Means.MFP2.DO.TS2.P <- Est.Means.MFP2.DO.TS2[-c(x + 1:ncol(Est.Means.MFP2.DO.TS2))]; Est.Means.MFP2.DO.TS2.I <- Est.Means.MFP2.DO.TS2[-c(1:x)]
Est.Means.MFP2.DO.TS2.P <- t(Est.Means.MFP2.DO.TS2.P); Est.Means.MFP2.DO.TS2.I <- t(Est.Means.MFP2.DO.TS2.I)

x <- ncol(Est.Means.MFP2.DO.TS3)/2
Est.Means.MFP2.DO.TS3.P <- Est.Means.MFP2.DO.TS3[-c(x + 1:ncol(Est.Means.MFP2.DO.TS3))]; Est.Means.MFP2.DO.TS3.I <- Est.Means.MFP2.DO.TS3[-c(1:x)]
Est.Means.MFP2.DO.TS3.P <- t(Est.Means.MFP2.DO.TS3.P); Est.Means.MFP2.DO.TS3.I <- t(Est.Means.MFP2.DO.TS3.I)

x <- ncol(Est.Means.MFP2.DO.TS4)/2
Est.Means.MFP2.DO.TS4.P <- Est.Means.MFP2.DO.TS4[-c(x + 1:ncol(Est.Means.MFP2.DO.TS4))]; Est.Means.MFP2.DO.TS4.I <- Est.Means.MFP2.DO.TS4[-c(1:x)]
Est.Means.MFP2.DO.TS4.P <- t(Est.Means.MFP2.DO.TS4.P); Est.Means.MFP2.DO.TS4.I <- t(Est.Means.MFP2.DO.TS4.I)

x <- ncol(Est.Means.MFP2.DO.TS5)/2
Est.Means.MFP2.DO.TS5.P <- Est.Means.MFP2.DO.TS5[-c(x + 1:ncol(Est.Means.MFP2.DO.TS5))]; Est.Means.MFP2.DO.TS5.I <- Est.Means.MFP2.DO.TS5[-c(1:x)]
Est.Means.MFP2.DO.TS5.P <- t(Est.Means.MFP2.DO.TS5.P); Est.Means.MFP2.DO.TS5.I <- t(Est.Means.MFP2.DO.TS5.I)

x <- ncol(Est.Means.MFP2.SLC.TS1)/2
Est.Means.MFP2.SLC.TS1.P <- Est.Means.MFP2.SLC.TS1[-c(x + 1:ncol(Est.Means.MFP2.SLC.TS1))]; Est.Means.MFP2.SLC.TS1.I <- Est.Means.MFP2.SLC.TS1[-c(1:x)]
Est.Means.MFP2.SLC.TS1.P <- t(Est.Means.MFP2.SLC.TS1.P); Est.Means.MFP2.SLC.TS1.I <- t(Est.Means.MFP2.SLC.TS1.I)
...
x <- ncol(Est.Means.MFP2.DivOsc.TS2)/2
Est.Means.MFP2.DivOsc.TS2.P <- Est.Means.MFP2.DivOsc.TS2[-c(x + 1:ncol(Est.Means.MFP2.DivOsc.TS2))]; Est.Means.MFP2.DivOsc.TS2.I <- Est.Means.MFP2.DivOsc.TS2[-c(1:x)]
Est.Means.MFP2.DivOsc.TS2.P <- t(Est.Means.MFP2.DivOsc.TS2.P); Est.Means.MFP2.DivOsc.TS2.I <- t(Est.Means.MFP2.DivOsc.TS2.I)

x <- ncol(Est.Means.MFP2.DivOsc.TS3)/2
Est.Means.MFP2.DivOsc.TS3.P <- Est.Means.MFP2.DivOsc.TS3[-c(x + 1:ncol(Est.Means.MFP2.DivOsc.TS3))]; Est.Means.MFP2.DivOsc.TS3.I <- Est.Means.MFP2.DivOsc.TS3[-c(1:x)]
Est.Means.MFP2.DivOsc.TS3.P <- t(Est.Means.MFP2.DivOsc.TS3.P); Est.Means.MFP2.DivOsc.TS3.I <- t(Est.Means.MFP2.DivOsc.TS3.I)

x <- ncol(Est.Means.MFP2.DivOsc.TS5)/2
Est.Means.MFP2.DivOsc.TS5.P <- Est.Means.MFP2.DivOsc.TS5[-c(x + 1:ncol(Est.Means.MFP2.DivOsc.TS5))]; Est.Means.MFP2.DivOsc.TS5.I <- Est.Means.MFP2.DivOsc.TS5[-c(1:x)]
Est.Means.MFP2.DivOsc.TS5.P <- t(Est.Means.MFP2.DivOsc.TS5.P); Est.Means.MFP2.DivOsc.TS5.I <- t(Est.Means.MFP2.DivOsc.TS5.I)

x <- ncol(Est.Means.MFP3.TS1)/2
Est.Means.MFP3.TS1.P <- Est.Means.MFP3.TS1[-c(x + 1:ncol(Est.Means.MFP3.TS1))]; Est.Means.MFP3.TS1.I <- Est.Means.MFP3.TS1[-c(1:x)]
Est.Means.MFP3.TS1.P <- t(Est.Means.MFP3.TS1.P); Est.Means.MFP3.TS1.I <- t(Est.Means.MFP3.TS1.I)

x <- ncol(Est.Means.MFP3.TS2)/2
Est.Means.MFP3.TS2.P <- Est.Means.MFP3.TS2[-c(x + 1:ncol(Est.Means.MFP3.TS2))]; Est.Means.MFP3.TS2.I <- Est.Means.MFP3.TS2[-c(1:x)]
Est.Means.MFP3.TS2.P <- t(Est.Means.MFP3.TS2.P); Est.Means.MFP3.TS2.I <- t(Est.Means.MFP3.TS2.I)

x <- ncol(Est.Means.MFP3.TS3)/2
Est.Means.MFP3.TS3.P <- Est.Means.MFP3.TS3[-c(x + 1:ncol(Est.Means.MFP3.TS3))]; Est.Means.MFP3.TS3.I <- Est.Means.MFP3.TS3[-c(1:x)]
Est.Means.MFP3.TS3.P <- t(Est.Means.MFP3.TS3.P); Est.Means.MFP3.TS3.I <- t(Est.Means.MFP3.TS3.I)

x <- ncol(Est.Means.MFP3.TS4)/2
Est.Means.MFP3.TS4.P <- Est.Means.MFP3.TS4[-c(x + 1:ncol(Est.Means.MFP3.TS4))]; Est.Means.MFP3.TS4.I <- Est.Means.MFP3.TS4[-c(1:x)]
Est.Means.MFP3.TS4.P <- t(Est.Means.MFP3.TS4.P); Est.Means.MFP3.TS4.I <- t(Est.Means.MFP3.TS4.I)
...
## Plotting
A.1.Dat <- read_csv("0_Data/1_Stochastic/Antia_Stoch_1.csv")
plot(x = 1:nrow(A.1.Dat), y = A.1.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = 1:nrow(A.1.Dat), y = A.1.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.A.TS1.P), y = Est.Means.A.TS1.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.A.TS1.I), y = Est.Means.A.TS1.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

A.2.Dat <- read_csv("0_Data/1_Stochastic/Antia_Stoch_2.csv")
plot(x = 1:nrow(A.2.Dat), y = A.2.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 800))
lines(x = 1:nrow(A.2.Dat), y = A.2.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.A.TS2.P), y = Est.Means.A.TS2.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.A.TS2.I), y = Est.Means.A.TS2.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

A.3.Dat <- read_csv("0_Data/1_Stochastic/Antia_Stoch_3.csv")
plot(x = 1:nrow(A.3.Dat), y = A.3.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 750))
lines(x = 1:nrow(A.3.Dat), y = A.3.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.A.TS3.P), y = Est.Means.A.TS3.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.A.TS3.I), y = Est.Means.A.TS3.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

A.4.Dat <- read_csv("0_Data/1_Stochastic/Antia_Stoch_4.csv")
plot(x = 1:nrow(A.4.Dat), y = A.4.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1500))
lines(x = 1:nrow(A.4.Dat), y = A.4.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.A.TS4.P), y = Est.Means.A.TS4.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.A.TS4.I), y = Est.Means.A.TS4.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

A.5.Dat <- read_csv("0_Data/1_Stochastic/Antia_Stoch_5.csv")
plot(x = 1:nrow(A.5.Dat), y = A.5.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1500))
lines(x = 1:nrow(A.5.Dat), y = A.5.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.A.TS5.P), y = Est.Means.A.TS5.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.A.TS5.I), y = Est.Means.A.TS5.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)
...
MFP2.DO.2.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_2.csv")
plot(x = 1:nrow(MFP2.DO.2.Dat), y = MFP2.DO.2.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 400))
lines(x = 1:nrow(MFP2.DO.2.Dat), y = MFP2.DO.2.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS2.P), y = Est.Means.MFP2.DO.TS2.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS2.I), y = Est.Means.MFP2.DO.TS2.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.DO.3.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_3.csv")
plot(x = 1:nrow(MFP2.DO.3.Dat), y = MFP2.DO.3.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 500))
lines(x = 1:nrow(MFP2.DO.3.Dat), y = MFP2.DO.3.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS3.P), y = Est.Means.MFP2.DO.TS3.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS3.I), y = Est.Means.MFP2.DO.TS3.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.DO.4.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_4.csv")
plot(x = 1:nrow(MFP2.DO.4.Dat), y = MFP2.DO.4.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 500))
lines(x = 1:nrow(MFP2.DO.4.Dat), y = MFP2.DO.4.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS4.P), y = Est.Means.MFP2.DO.TS4.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS4.I), y = Est.Means.MFP2.DO.TS4.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.DO.5.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_5.csv")
plot(x = 1:nrow(MFP2.DO.5.Dat), y = MFP2.DO.5.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 500))
lines(x = 1:nrow(MFP2.DO.5.Dat), y = MFP2.DO.5.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS5.P), y = Est.Means.MFP2.DO.TS5.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DO.TS5.I), y = Est.Means.MFP2.DO.TS5.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP2.SLC.1.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_1.csv")
plot(x = 1:nrow(MFP2.SLC.1.Dat), y = MFP2.SLC.1.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 300))
lines(x = 1:nrow(MFP2.SLC.1.Dat), y = MFP2.SLC.1.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS1.P), y = Est.Means.MFP2.SLC.TS1.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.SLC.TS1.I), y = Est.Means.MFP2.SLC.TS1.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)
...
MFP2.DivOsc.2.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_2.csv")
plot(x = 1:nrow(MFP2.DivOsc.2.Dat), y = MFP2.DivOsc.2.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 300))
lines(x = 1:nrow(MFP2.DivOsc.2.Dat), y = MFP2.DivOsc.2.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS2.P), y = Est.Means.MFP2.DivOsc.TS2.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS2.I), y = Est.Means.MFP2.DivOsc.TS2.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)
...
MFP2.DivOsc.5.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_5.csv")
plot(x = 1:nrow(MFP2.DivOsc.5.Dat), y = MFP2.DivOsc.5.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 350))
lines(x = 1:nrow(MFP2.DivOsc.5.Dat), y = MFP2.DivOsc.5.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS5.P), y = Est.Means.MFP2.DivOsc.TS5.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP2.DivOsc.TS5.I), y = Est.Means.MFP2.DivOsc.TS5.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP3.1.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_1.csv")
plot(x = 1:nrow(MFP3.1.Dat), y = MFP3.1.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 200))
lines(x = 1:nrow(MFP3.1.Dat), y = MFP3.1.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP3.TS1.P), y = Est.Means.MFP3.TS1.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP3.TS1.I), y = Est.Means.MFP3.TS1.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP3.2.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_2.csv")
plot(x = 1:nrow(MFP3.2.Dat), y = MFP3.2.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 200))
lines(x = 1:nrow(MFP3.2.Dat), y = MFP3.2.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP3.TS2.P), y = Est.Means.MFP3.TS2.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP3.TS2.I), y = Est.Means.MFP3.TS2.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP3.3.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_3.csv")
plot(x = 1:nrow(MFP3.3.Dat), y = MFP3.3.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 200))
lines(x = 1:nrow(MFP3.3.Dat), y = MFP3.3.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP3.TS3.P), y = Est.Means.MFP3.TS3.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP3.TS3.I), y = Est.Means.MFP3.TS3.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP3.4.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_4.csv")
plot(x = 1:nrow(MFP3.4.Dat), y = MFP3.4.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 200))
lines(x = 1:nrow(MFP3.4.Dat), y = MFP3.4.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP3.TS4.P), y = Est.Means.MFP3.TS4.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP3.TS4.I), y = Est.Means.MFP3.TS4.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)

MFP3.5.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_5.csv")
plot(x = 1:nrow(MFP3.5.Dat), y = MFP3.5.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 200))
lines(x = 1:nrow(MFP3.5.Dat), y = MFP3.5.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP3.TS5.P), y = Est.Means.MFP3.TS5.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP3.TS5.I), y = Est.Means.MFP3.TS5.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)
```
...
```{r}
## Pulling Posterior
Output.A.TS1 <- rstan::extract(MFP2Model_MisMatch_G[["A.1"]], permuted = TRUE, include = TRUE)
Output.A.TS3 <- rstan::extract(MFP2Model_MisMatch_G[["A.3"]], permuted = TRUE, include = TRUE)
Output.A.TS4 <- rstan::extract(MFP2Model_MisMatch_G[["A.4"]], permuted = TRUE, include = TRUE)
Output.A.TS5 <- rstan::extract(MFP2Model_MisMatch_G[["A.5"]], permuted = TRUE, include = TRUE)
Output.MFP1.TS1 <- rstan::extract(MFP2Model_MisMatch_G[["T3.1"]], permuted = TRUE, include = TRUE)
Output.MFP1.TS3 <- rstan::extract(MFP2Model_MisMatch_G[["T3.3"]], permuted = TRUE, include = TRUE)
Output.MFP1.TS5 <- rstan::extract(MFP2Model_MisMatch_G[["T3.5"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS3 <- rstan::extract(MFP2Model_MisMatch_G[["T3.3"]], permuted = TRUE, include = TRUE)
Output.MFP3.TS5 <- rstan::extract(MFP2Model_MisMatch_G[["T3.5"]], permuted = TRUE, include = TRUE)
...
Est.A.TS4 <- data.frame(Output.A.TS4$y_rep); Est.Means.A.TS4 <- Est.A.TS4 %>% summarise(across(.cols = everything(), .fns = mean))
Est.A.TS5 <- data.frame(Output.A.TS5$y_rep); Est.Means.A.TS5 <- Est.A.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP1.TS1 <- data.frame(Output.MFP1.TS1$y_rep); Est.Means.MFP1.TS1 <- Est.MFP1.TS1 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP1.TS3 <- data.frame(Output.MFP1.TS3$y_rep); Est.Means.MFP1.TS3 <- Est.MFP1.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP1.TS5 <- data.frame(Output.MFP1.TS5$y_rep); Est.Means.MFP1.TS5 <- Est.MFP1.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS3 <- data.frame(Output.MFP3.TS3$y_rep); Est.Means.MFP3.TS3 <- Est.MFP3.TS3 %>% summarise(across(.cols = everything(), .fns = mean))
Est.MFP3.TS5 <- data.frame(Output.MFP3.TS5$y_rep); Est.Means.MFP3.TS5 <- Est.MFP3.TS5 %>% summarise(across(.cols = everything(), .fns = mean))
...
x <- ncol(Est.Means.MFP1.TS1)/2
Est.Means.MFP1.TS1.P <- Est.Means.MFP1.TS1[-c(x + 1:ncol(Est.Means.MFP1.TS1))]; Est.Means.MFP1.TS1.I <- Est.Means.MFP1.TS1[-c(1:x)]
Est.Means.MFP1.TS1.P <- t(Est.Means.MFP1.TS1.P); Est.Means.MFP1.TS1.I <- t(Est.Means.MFP1.TS1.I)

x <- ncol(Est.Means.MFP1.TS3)/2
Est.Means.MFP1.TS3.P <- Est.Means.MFP1.TS3[-c(x + 1:ncol(Est.Means.MFP1.TS3))]; Est.Means.MFP1.TS3.I <- Est.Means.MFP1.TS3[-c(1:x)]
Est.Means.MFP1.TS3.P <- t(Est.Means.MFP1.TS3.P); Est.Means.MFP1.TS3.I <- t(Est.Means.MFP1.TS3.I)

x <- ncol(Est.Means.MFP1.TS5)/2
Est.Means.MFP1.TS5.P <- Est.Means.MFP1.TS5[-c(x + 1:ncol(Est.Means.MFP1.TS5))]; Est.Means.MFP1.TS5.I <- Est.Means.MFP1.TS5[-c(1:x)]
Est.Means.MFP1.TS5.P <- t(Est.Means.MFP1.TS5.P); Est.Means.MFP1.TS5.I <- t(Est.Means.MFP1.TS5.I)
...
MFP1.1.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_1.csv")
plot(x = 1:nrow(MFP1.1.Dat), y = MFP1.1.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 200))
lines(x = 1:nrow(MFP1.1.Dat), y = MFP1.1.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP1.TS1.P), y = Est.Means.MFP1.TS1.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP1.TS1.I), y = Est.Means.MFP1.TS1.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)
...
MFP1.5.Dat <- read_csv("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_5.csv")
plot(x = 1:nrow(MFP1.5.Dat), y = MFP1.5.Dat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 200))
lines(x = 1:nrow(MFP1.5.Dat), y = MFP1.5.Dat$I, col = "cornflowerblue", lwd = 2)
lines(x = 1:nrow(Est.Means.MFP1.TS5.P), y = Est.Means.MFP1.TS5.P[ , 1], col = "forestgreen", lwd = 2, lty = 3)
lines(x = 1:nrow(Est.Means.MFP1.TS5.I), y = Est.Means.MFP1.TS5.I[ , 1], col = "cornflowerblue", lwd = 2, lty = 3)
...
```{r}
## Pulling Posterior
Output.A.TS2 <- rstan::extract(MFP3Model_MisMatch_G[["A.1"]], permuted = TRUE, include = TRUE)
Output.A.TS4 <- rstan::extract(MFP2Model_MisMatch_G[["A.4"]], permuted = TRUE, include = TRUE)
Output.A.TS5 <- rstan::extract(MFP2Model_MisMatch_G[["A.5"]], permuted = TRUE, include = TRUE)
...
```{r}
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T1.1"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
for (t in 2:t_stop){
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Discrete.rds"); StochDat <- StochDat[[1]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
lines(x = Antia_Det$Time, y = Antia_Det$P, col = "forestgreen", lwd = 2, lty = 3)
lines(x = Antia_Det$Time, y = Antia_Det$I, col = "cornflowerblue", lwd = 2, lty = 3)

Post <- rstan::extract(AntiaModel_MisMatch_AR[["T1.2"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Discrete.rds"); StochDat <- StochDat[[2]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T1.3"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Discrete.rds"); StochDat <- StochDat[[3]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T1.4"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Discrete.rds"); StochDat <- StochDat[[4]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T1.5"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_1_Stoch_Discrete.rds"); StochDat <- StochDat[[5]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T2.DO.4"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Discrete.rds"); StochDat <- StochDat[[4]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T2.SLC.1"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Discrete.rds"); StochDat <- StochDat[[1]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T3.2"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Discrete.rds"); StochDat <- StochDat[[2]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T3.3"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Discrete.rds"); StochDat <- StochDat[[3]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(AntiaModel_MisMatch_AR[["T3.5"]], pars = c("r", "k", "p", "o"))
r = mean(Post[[1]]); k = mean(Post[[2]]); p = mean(Post[[3]]); o = mean(Post[[4]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 55/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Discrete.rds"); StochDat <- StochDat[[5]]
Antia_Det <- data.frame(seq(0.1, 55, 0.1), P, I); colnames(Antia_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 2000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
```{r}
Post <- rstan::extract(MFP1Model_MisMatch_AR[["A.2"]], pars = c("r", "B", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 10; I[1] = 10
ts = 0.1; t_stop = 80/ts
for (t in 2:t_stop){
...
StochDat <- readRDS("0_Data/1_Stochastic/Antia_Stoch_Discrete.rds"); StochDat <- StochDat[[2]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 80, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
lines(x = ModFentonPerkins_Det$Time, y = ModFentonPerkins_Det$P, col = "forestgreen", lwd = 2, lty = 3)
lines(x = ModFentonPerkins_Det$Time, y = ModFentonPerkins_Det$I, col = "cornflowerblue", lwd = 2, lty = 3)

Post <- rstan::extract(MFP1Model_MisMatch_AR[["A.3"]], pars = c("r", "B", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 10; I[1] = 10
ts = 0.1; t_stop = 80/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/Antia_Stoch_Discrete.rds"); StochDat <- StochDat[[3]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 80, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP1Model_MisMatch_AR[["A.4"]], pars = c("r", "B", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 10; I[1] = 10
ts = 0.1; t_stop = 80/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/Antia_Stoch_Discrete.rds"); StochDat <- StochDat[[4]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 80, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
```{r}
Post <- rstan::extract(MFP2Model_MisMatch_AR[["A.1"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/Antia_Stoch_Discrete.rds"); StochDat <- StochDat[[1]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["A.2"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["A.3"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["A.4"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["A.5"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/Antia_Stoch_Discrete.rds"); StochDat <- StochDat[[5]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["T3.1"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Discrete.rds"); StochDat <- StochDat[[1]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["T3.2"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["T3.3"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["T3.4"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_3_Stoch_Discrete.rds"); StochDat <- StochDat[[4]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP2Model_MisMatch_AR[["T3.5"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 80; I[1] = 200
ts = 0.1; t_stop = 60/ts
...
```{r}
Post <- rstan::extract(MFP3Model_MisMatch_AR[["A.1"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["A.2"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["A.3"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["A.4"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["A.5"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DO.1"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Discrete.rds"); StochDat <- StochDat[[1]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DO.2"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Discrete.rds"); StochDat <- StochDat[[2]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DO.3"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Discrete.rds"); StochDat <- StochDat[[3]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DO.4"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DO.5"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DO_Stoch_Discrete.rds"); StochDat <- StochDat[[5]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.SLC.1"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.SLC.2"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Discrete.rds"); StochDat <- StochDat[[2]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.SLC.3"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Discrete.rds"); StochDat <- StochDat[[3]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.SLC.4"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Discrete.rds"); StochDat <- StochDat[[4]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.SLC.5"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_SLC_Stoch_Discrete.rds"); StochDat <- StochDat[[5]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DivOsc.1"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Discrete.rds"); StochDat <- StochDat[[1]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DivOsc.2"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Discrete.rds"); StochDat <- StochDat[[2]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DivOsc.3"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Discrete.rds"); StochDat <- StochDat[[3]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DivOsc.4"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Discrete.rds"); StochDat <- StochDat[[4]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
Post <- rstan::extract(MFP3Model_MisMatch_AR[["T2.DivOsc.5"]], pars = c("r", "B", "h", "b", "e", "delta"))
r = mean(Post[[1]]); B = mean(Post[[2]]); b = mean(Post[[3]]); e = mean(Post[[4]]); delta = mean(Post[[5]])
P <- c(); I <- c()
P[1] = 1; I[1] = 1
ts = 0.1; t_stop = 60/ts
...
StochDat <- readRDS("0_Data/1_Stochastic/ModFentonPerkins_2_DivOsc_Stoch_Discrete.rds"); StochDat <- StochDat[[5]]
ModFentonPerkins_Det <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
plot(x = StochDat$Time, y = StochDat$P, col = "forestgreen", lwd = 2, 
     xlab = "Time", ylab = "Population Abundance", type = "l", ylim = c(0, 1000))
lines(x = StochDat$Time, y = StochDat$I, col = "cornflowerblue", lwd = 2)
...
### Mod. Fenton and Perkins, Type II FR, Damping Oscillations

```{r}
# post.1 <- rstan::extract(ModFentonPerkins_2_DO_FitObj1, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"))
# post.2 <- rstan::extract(ModFentonPerkins_2_DO_FitObj2, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"))
# post.3 <- rstan::extract(ModFentonPerkins_2_DO_FitObj3, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"))
# post.4 <- rstan::extract(ModFentonPerkins_2_DO_FitObj4, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"))
# post.5 <- rstan::extract(ModFentonPerkins_2_DO_FitObj5, pars = c("theta[1]", "theta[2]", "theta[3]", "theta[4]", "theta[5]", "theta[6]"))
# post <- mapply(c, post.1, post.2, post.3, post.4, post.5, SIMPLIFY = FALSE)
# n.sim <- 2000
# set.seed(123); samps <- sample(length(post[[1]]), n.sim, replace = FALSE)
# samp.post <- vector(mode = "list", length = length(post))
# for (i in 1:n.sim){
#   samp.post[[1]][i] <- post[[1]][samps[i]]
#   samp.post[[2]][i] <- post[[2]][samps[i]]
#   samp.post[[3]][i] <- post[[3]][samps[i]]
#   samp.post[[4]][i] <- post[[4]][samps[i]]
#   samp.post[[5]][i] <- post[[5]][samps[i]]
#   samp.post[[6]][i] <- post[[6]][samps[i]]
# }
# inits.1 <- rstan::extract(ModFentonPerkins_2_DO_FitObj1, pars = "y_init_rep")
# inits.1 <- list(inits.1[[1]][ , 1], inits.1[[1]][ , 2])
# inits.2 <- rstan::extract(ModFentonPerkins_2_DO_FitObj2, pars = "y_init_rep")
# inits.2 <- list(inits.2[[1]][ , 1], inits.2[[1]][ , 2])
# inits.3 <- rstan::extract(ModFentonPerkins_2_DO_FitObj3, pars = "y_init_rep")
# inits.3 <- list(inits.3[[1]][ , 1], inits.3[[1]][ , 2])
# inits.4 <- rstan::extract(ModFentonPerkins_2_DO_FitObj4, pars = "y_init_rep")
# inits.4 <- list(inits.4[[1]][ , 1], inits.4[[1]][ , 2])
# inits.5 <- rstan::extract(ModFentonPerkins_2_DO_FitObj5, pars = "y_init_rep")
# inits.5 <- list(inits.5[[1]][ , 1], inits.5[[1]][ , 2])
# inits <- mapply(c, inits.1, inits.2, inits.3, inits.4, inits.5, SIMPLIFY = FALSE)
# samp.inits <- vector(mode = "list", length = length(inits))
# for (i in 1:n.sim){
#   samp.inits[[1]][i] <- inits[[1]][samps[i]]
#   samp.inits[[2]][i] <- inits[[2]][samps[i]]
# }
# 
# Mod_FP_T2 <- function(t, y, p){
#   r <- p[1]; B <- p[2]; h <- p[3]; e <- p[4]; delta <- p[5]
...
# }
# 
# DampOsc_SA_Outputs <- list(); DampOsc_TS_Length <- c()
# for (i in 1:n.sim){
#   r <- samp.post[[1]][i]; B <- samp.post[[2]][i]; h <- samp.post[[3]][i] 
#   b <- samp.post[[4]][i]; e <- samp.post[[5]][i]; delta <- samp.post[[6]][i]
#   parms <- c(r, B, h, b, e, delta)
#   P0 <- samp.inits[[1]][i]; I0 <- samp.inits[[2]][i]
#   N0 <- c(P0, I0)
#   TT <- seq(0, 400, 0.1)
#   results <- as.data.frame(lsoda(N0, TT, Mod_FP_T2, parms)); colnames(results) <- c("Time", "P", "I")
#   results <- results[1:which(results$P < 0)[1] - 1, ]
#   DampOsc_SA_Outputs[[i]] <- results; DampOsc_TS_Length[i] <- nrow(results)/10
# }
# max(DampOsc_TS_Length)

# Posterior time series
TS1 <- rstan::extract(ModFentonPerkins_2_DO_FitObj1, pars = c("y_rep"))[[1]]
TS1.P <- as.matrix(TS1[ , , 1]); TS1.I <- as.matrix(TS1[ , , 2])
TS5 <- rstan::extract(ModFentonPerkins_2_DO_FitObj5, pars = c("y_rep"))[[1]]
TS5.P <- as.matrix(TS5[ , , 1]); TS5.I <- as.matrix(TS5[ , , 2])
n.sim <- 2000
set.seed(123); samps <- sample(nrow(TS1.P), n.sim/2, replace = FALSE)
TS1.P <- TS1.P[samps, ]; TS1.I <- TS1.I[samps, ]
TS5.P <- TS5.P[samps, ]; TS5.I <- TS5.I[samps, ]

# Plotting time series
plot(1, type = "n", main = "Mod. Fenton and Perkins (2010), Type II FR (Damping Oscillations) | Time Series Drawn from Posterior Distributions (Global Model)", xlab = "Time", ylab = "Abundance", xlim = c(0, 96), ylim = c(0, 800))
for (i in 1:ncol(TS1.P)){
  lines(x = seq(1:ncol(TS1.P)), y = TS1.P[i, ], col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = seq(1:ncol(TS1.I)), y = TS1.I[i, ], col = adjustcolor("cornflowerblue", alpha = 0.2))
}
for (i in 1:ncol(TS5.P)){
  lines(x = seq(1:ncol(TS5.P)), y = TS5.P[i, ], col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = seq(1:ncol(TS5.I)), y = TS5.I[i, ], col = adjustcolor("cornflowerblue", alpha = 0.2))
}

Is.DampOsc <- c()
for (i in 1:n.sim){
  TS <- DampOsc.AR_SA_Outputs[[i]][ , 2:3]
  Max.First10Days <- rev(sort(TS[1:100, 1]))[1:10]; Min.First10Days <- sort(TS[1:100, 1])[1:10]
  Max.Last10Days <- rev(sort(TS[500:600, 1]))[1:10]; Min.Last10Days <- sort(TS[500:600, 1])[1:10]
  Diff.Start <- mean(Max.First10Days) - mean(Min.First10Days); Diff.End <- mean(Max.Last10Days) - mean(Min.Last10Days)
...
length(which(Is.DampOsc == "Y"))/length(Is.DampOsc)

```

### Mod. Fenton and Perkins, Type II FR, Stable Limit Cycle

```{r}
# Posterior time series
TS1 <- rstan::extract(ModFentonPerkins_2_SLC_FitObj1, pars = c("y_rep"))[[1]]
TS1.P <- as.matrix(TS1[ , , 1]); TS1.I <- as.matrix(TS1[ , , 2])
TS2 <- rstan::extract(ModFentonPerkins_2_SLC_FitObj2, pars = c("y_rep"))[[1]]
TS2.P <- as.matrix(TS2[ , , 1]); TS2.I <- as.matrix(TS2[ , , 2])
TS5 <- rstan::extract(ModFentonPerkins_2_SLC_FitObj5, pars = c("y_rep"))[[1]]
TS5.P <- as.matrix(TS5[ , , 1]); TS5.I <- as.matrix(TS5[ , , 2])
n.sim <- 2000
set.seed(123); samps <- sample(nrow(TS1.P), round(n.sim/3), replace = FALSE)
TS1.P <- TS1.P[samps, ]; TS1.I <- TS1.I[samps, ]
TS2.P <- TS2.P[samps, ]; TS2.I <- TS2.I[samps, ]
TS5.P <- TS5.P[samps, ]; TS5.I <- TS5.I[samps, ]

# Plotting time series
plot(1, type = "n", main = "Mod. Fenton and Perkins (2010), Type II FR (Stable Limit Cycle) | Time Series Drawn from Posterior Distributions (Global Model)", xlab = "Time", ylab = "Abundance", xlim = c(1, 25), ylim = c(0, 600))
for (i in 1:ncol(TS1.P)){
  lines(x = seq(1:ncol(TS1.P)), y = TS1.P[i, ], col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = seq(1:ncol(TS1.I)), y = TS1.I[i, ], col = adjustcolor("cornflowerblue", alpha = 0.2))
}
for (i in 1:ncol(TS2.P)){
  lines(x = seq(1:ncol(TS2.P)), y = TS2.P[i, ], col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = seq(1:ncol(TS2.I)), y = TS2.I[i, ], col = adjustcolor("cornflowerblue", alpha = 0.2))
}
for (i in 1:ncol(TS5.P)){
  lines(x = seq(1:ncol(TS5.P)), y = TS5.P[i, ], col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = seq(1:ncol(TS5.I)), y = TS5.I[i, ], col = adjustcolor("cornflowerblue", alpha = 0.2))
...
### Mod. Fenton and Perkins, Type II FR, Divergent Oscillations

```{r}
# Posterior time series
TS2 <- rstan::extract(ModFentonPerkins_2_DivOsc_FitObj2, pars = c("y_rep"))[[1]]
TS2.P <- as.matrix(TS2[ , , 1]); TS2.I <- as.matrix(TS2[ , , 2])
TS5 <- rstan::extract(ModFentonPerkins_2_DivOsc_FitObj5, pars = c("y_rep"))[[1]]
TS5.P <- as.matrix(TS5[ , , 1]); TS5.I <- as.matrix(TS5[ , , 2])
n.sim <- 2000
set.seed(123); samps <- sample(nrow(TS1.P), n.sim/2, replace = FALSE)
TS2.P <- TS2.P[samps, ]; TS2.I <- TS2.I[samps, ]
...
# Plotting time series
plot(1, type = "n", main = "Mod. Fenton and Perkins (2010), Type II FR (Divergent Oscillations) | Time Series Drawn from Posterior Distributions (Global Model)", xlab = "Time", ylab = "Abundance", xlim = c(1, 50), ylim = c(0, 1000))
for (i in 1:ncol(TS2.P)){
  lines(x = seq(1:ncol(TS2.P)), y = TS2.P[i, ], col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = seq(1:ncol(TS2.I)), y = TS2.I[i, ], col = adjustcolor("cornflowerblue", alpha = 0.2))
}
...
```{r}
post.1 <- rstan::extract(MFP.II.DampOsc.1.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.2 <- rstan::extract(MFP.II.DampOsc.2.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.3 <- rstan::extract(MFP.II.DampOsc.3.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.4 <- rstan::extract(MFP.II.DampOsc.4.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.5 <- rstan::extract(MFP.II.DampOsc.5.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post <- mapply(c, post.1, post.2, post.3, post.4, post.5, SIMPLIFY = FALSE)
n.sim <- 10000
set.seed(123); samps <- sample(length(post[[1]]), n.sim, replace = FALSE)
samp.post <- vector(mode = "list", length = length(post))
...
DampOsc.AR_SA_Outputs <- list(); DampOsc.AR_TS_Length <- c()
for (i in 1:n.sim){
  r = samp.post[[1]][i]; B = samp.post[[2]][i]; h = samp.post[[3]][i] 
  b = samp.post[[4]][i]; e = samp.post[[5]][i]; delta = samp.post[[6]][i]
  P <- c(); I <- c()
  ...
  results <- data.frame(seq(0.1, 60, 0.1), P, I); colnames(results) <- c("Time", "P", "I")
  if (length(which(results$P < 0)) >= 1){
    results <- results[1:which(results$P < 0)[1] - 1, ]
  }
  DampOsc.AR_SA_Outputs[[i]] <- results; DampOsc.AR_TS_Length[i] <- nrow(results)/10
}
max(DampOsc.AR_TS_Length)

plot(1, type = "n", main = "Mod. Fenton and Perkins (2010), Type II FR (Damping Oscillations) | Parameter Values Drawn from Posterior Distributions (AR-1 Model)", xlab = "Time", ylab = "Abundance", xlim = c(0, 60), ylim = c(0, 1500))
for (i in 1:n.sim){
  lines(x = DampOsc.AR_SA_Outputs[[i]]$Time, y = DampOsc.AR_SA_Outputs[[i]]$P, col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = DampOsc.AR_SA_Outputs[[i]]$Time, y = DampOsc.AR_SA_Outputs[[i]]$I, col = adjustcolor("cornflowerblue", alpha = 0.2))
}

# Checking to see if all time series are same length
TSLengths <- c()
for (i in 1:n.sim){
  TSLengths[i] <- nrow(DampOsc.AR_SA_Outputs[[i]])
}; length(unique(TSLengths))
...
length(which(Is.DampOsc == "Y"))/length(Is.DampOsc) # 84.27%
```

### Mod. Fenton and Perkins, Type II FR, Stable Limit Cycle

```{r}
post.1 <- rstan::extract(MFP.II.SLC.1.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.2 <- rstan::extract(MFP.II.SLC.2.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.3 <- rstan::extract(MFP.II.SLC.3.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.4 <- rstan::extract(MFP.II.SLC.4.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.5 <- rstan::extract(MFP.II.SLC.5.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post <- mapply(c, post.1, post.2, post.3, post.4, post.5, SIMPLIFY = FALSE)
n.sim <- 10000
set.seed(123); samps <- sample(length(post[[1]]), n.sim, replace = FALSE)
samp.post <- vector(mode = "list", length = length(post))
...
SLC.AR_SA_Outputs <- list(); SLC.AR_TS_Length <- c()
for (i in 1:n.sim){
  r = samp.post[[1]][i]; B = samp.post[[2]][i]; h = samp.post[[3]][i] 
  b = samp.post[[4]][i]; e = samp.post[[5]][i]; delta = samp.post[[6]][i]
  P <- c(); I <- c()
  ...
  SLC.AR_SA_Outputs[[i]] <- results; SLC.AR_TS_Length[i] <- nrow(results)/10
}
max(SLC.AR_TS_Length)

plot(1, type = "n", main = "Mod. Fenton and Perkins (2010), Type II FR (Stable Limit Cycle) | Parameter Values Drawn from Posterior Distributions (AR-1 Model)", xlab = "Time", ylab = "Abundance", xlim = c(0, 60), ylim = c(0, 1500))
for (i in 1:n.sim){
  lines(x = SLC.AR_SA_Outputs[[i]]$Time, y = SLC.AR_SA_Outputs[[i]]$P, col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = SLC.AR_SA_Outputs[[i]]$Time, y = SLC.AR_SA_Outputs[[i]]$I, col = adjustcolor("cornflowerblue", alpha = 0.2))
}

# Checking to see if all time series are same length
TSLengths <- c()
for (i in 1:n.sim){
  TSLengths[i] <- nrow(SLC.AR_SA_Outputs[[i]])
}; length(unique(TSLengths))

# Classifying behaviour
Is.SLC <- c()
for (i in 1:n.sim){
  TS <- SLC.AR_SA_Outputs[[i]][ , 2:3]
  Max.First10Days <- rev(sort(TS[1:100, 1]))[1:10]; Min.First10Days <- sort(TS[1:100, 1])[1:10]
  Max.Last10Days <- rev(sort(TS[500:600, 1]))[1:10]; Min.Last10Days <- sort(TS[500:600, 1])[1:10]
  Diff.Start <- mean(Max.First10Days) - mean(Min.First10Days); Diff.End <- mean(Max.Last10Days) - mean(Min.Last10Days)
  if (Diff.Start - Diff.End < abs(1)){
    Is.SLC[i] <- "Y"
    } else {
      Is.SLC[i] <- "N"
    }
}
length(which(Is.SLC == "Y"))/length(Is.SLC) # 24.19%
```

### Mod. Fenton and Perkins, Type II FR, Divergent Oscillations

```{r}
post.1 <- rstan::extract(MFP.II.DivOsc.1.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.2 <- rstan::extract(MFP.II.DivOsc.2.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.3 <- rstan::extract(MFP.II.DivOsc.3.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.4 <- rstan::extract(MFP.II.DivOsc.4.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post.5 <- rstan::extract(MFP.II.DivOsc.5.AR.Fit, pars = c("r", "B", "h", "b", "e", "delta"))
post <- mapply(c, post.1, post.2, post.3, post.4, post.5, SIMPLIFY = FALSE)
n.sim <- 10000
set.seed(123); samps <- sample(length(post[[1]]), n.sim, replace = FALSE)
samp.post <- vector(mode = "list", length = length(post))
...
DivOsc.AR_SA_Outputs <- list(); DivOsc.AR_TS_Length <- c()
for (i in 1:n.sim){
  r = samp.post[[1]][i]; B = samp.post[[2]][i]; h = samp.post[[3]][i] 
  b = samp.post[[4]][i]; e = samp.post[[5]][i]; delta = samp.post[[6]][i]
  P <- c(); I <- c()
  ...
  DivOsc.AR_SA_Outputs[[i]] <- results; DivOsc.AR_TS_Length[i] <- nrow(results)/10
}
max(DivOsc.AR_TS_Length)

plot(1, type = "n", main = "Mod. Fenton and Perkins (2010), Type II FR (Divergent Oscillations) | Parameter Values Drawn from Posterior Distributions (AR-1 Model)", xlab = "Time", ylab = "Abundance", xlim = c(0, 60), ylim = c(0, 1500))
for (i in 1:n.sim){
  lines(x = DivOsc.AR_SA_Outputs[[i]]$Time, y = DivOsc.AR_SA_Outputs[[i]]$P, col = adjustcolor("forestgreen", alpha = 0.2))
  lines(x = DivOsc.AR_SA_Outputs[[i]]$Time, y = DivOsc.AR_SA_Outputs[[i]]$I, col = adjustcolor("cornflowerblue", alpha = 0.2))
}

# Checking to see if all time series are same length
TSLengths <- c()
for (i in 1:n.sim){
  TSLengths[i] <- nrow(DivOsc.AR_SA_Outputs[[i]])
}; length(unique(TSLengths))

# Classifying behaviour
Is.DivOsc <- c()
for (i in 1:n.sim){
  TS <- DivOsc.AR_SA_Outputs[[i]][ , 2:3]
  Max.First10Days <- rev(sort(TS[1:100, 1]))[1:10]; Min.First10Days <- sort(TS[1:100, 1])[1:10]
  Max.Last10Days <- rev(sort(TS[500:600, 1]))[1:10]; Min.Last10Days <- sort(TS[500:600, 1])[1:10]
  Diff.Start <- mean(Max.First10Days) - mean(Min.First10Days); Diff.End <- mean(Max.Last10Days) - mean(Min.Last10Days)
  if (Diff.Start < Diff.End){
...
length(which(Is.DivOsc == "Y"))/length(Is.DivOsc) # 72.32% 
```
