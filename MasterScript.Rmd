...
AntiaModel_StanData_List <- StanData_List[c(5:30)]
...
MFP1Model_StanData_List <- StanData_List[c(1:5, 16:30)] # Antia, MFP2 (SLC and DivOsc), MFP 3
...
MFP3Model_StanData_List <- StanData_List[c(1:10, 16:25)] # Antia, MFP1, MFP2 (SLC, DivOsc)
...
saveRDS(MisMatchedFits_Type1Model, "2_FitObjects/MismatchedFits/MisMatchedFits_Type1Model.rds")
saveRDS(MisMatchedFits_Type2Model, "2_FitObjects/MismatchedFits/MisMatchedFits_Type2Model.rds")
saveRDS(MisMatchedFits_Type3Model, "2_FitObjects/MismatchedFits/MisMatchedFits_Type3Model.rds")

MisMatchedFits_Type1Model <- readRDS("2_FitObjects/MismatchedFits/MisMatchedFits_Type1Model.rds")
...
T3Data.T1Model_G.Fit1 <- MisMatchedFits_Type1Model[[7]]
T3Data.T1Model_G.Fit1 <- MisMatchedFits_Type1Model[[8]]
T3Data.T1Model_G.Fit1 <- MisMatchedFits_Type1Model[[9]]
T3Data.T1Model_G.Fit1 <- MisMatchedFits_Type1Model[[10]]

MisMatchedFits_Type2Model <- readRDS("2_FitObjects/MismatchedFits/MisMatchedFits_Type2Model.rds")
...
MisMatchedFits_Type3Model <- readRDS("2_FitObjects/MismatchedFits/MisMatchedFits_Type3Model.rds")
...
saveRDS(MisMatchedFits_Type1Model_AR, "2_FitObjects/MismatchedFits/MisMatchedFits_Type1Model_AR.rds")
saveRDS(MisMatchedFits_Type2Model_AR, "2_FitObjects/MismatchedFits/MisMatchedFits_Type2Model_AR.rds")
saveRDS(MisMatchedFits_Type3Model_AR, "2_FitObjects/MismatchedFits/MisMatchedFits_Type3Model_AR.rds")

MisMatchedFits_Type1Model <- readRDS("2_FitObjects/MismatchedFits/MisMatchedFits_Type1Model_AR.rds")
for (i in 1:length(MisMatchedFits_Type1Model)){
  print(MisMatchedFits_Type1Model[[i]], pars = c("r", "B", "b", "e", "delta"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
}
T2Data.T1Model_AR.Fit1 <- MisMatchedFits_Type1Model[[1]]
T2Data.T1Model_AR.Fit2 <- MisMatchedFits_Type1Model[[2]]
T2Data.T1Model_AR.Fit3 <- MisMatchedFits_Type1Model[[3]]
T2Data.T1Model_AR.Fit4 <- MisMatchedFits_Type1Model[[4]]
T2Data.T1Model_AR.Fit5 <- MisMatchedFits_Type1Model[[5]]
T3Data.T1Model_AR.Fit1 <- MisMatchedFits_Type1Model[[6]]
T3Data.T1Model_AR.Fit1 <- MisMatchedFits_Type1Model[[7]]
T3Data.T1Model_AR.Fit1 <- MisMatchedFits_Type1Model[[8]]
T3Data.T1Model_AR.Fit1 <- MisMatchedFits_Type1Model[[9]]
T3Data.T1Model_AR.Fit1 <- MisMatchedFits_Type1Model[[10]]

MisMatchedFits_Type2Model <- readRDS("2_FitObjects/MismatchedFits/MisMatchedFits_Type2Model_AR.rds")
for (i in 1:length(MisMatchedFits_Type2Model)){
  print(MisMatchedFits_Type2Model[[i]], pars = c("r", "B", "b", "e", "delta"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
}
T1Data.T2Model_AR.Fit1 <- MisMatchedFits_Type2Model[[1]]
T1Data.T2Model_AR.Fit2 <- MisMatchedFits_Type2Model[[2]]
T1Data.T2Model_AR.Fit3 <- MisMatchedFits_Type2Model[[3]]
T1Data.T2Model_AR.Fit4 <- MisMatchedFits_Type2Model[[4]]
T1Data.T2Model_AR.Fit5 <- MisMatchedFits_Type2Model[[5]]
T3Data.T2Model_AR.Fit1 <- MisMatchedFits_Type2Model[[6]]
T3Data.T2Model_AR.Fit2 <- MisMatchedFits_Type2Model[[7]]
T3Data.T2Model_AR.Fit3 <- MisMatchedFits_Type2Model[[8]]
T3Data.T2Model_AR.Fit4 <- MisMatchedFits_Type2Model[[9]]
T3Data.T2Model_AR.Fit5 <- MisMatchedFits_Type2Model[[10]]

MisMatchedFits_Type3Model <- readRDS("2_FitObjects/MismatchedFits/MisMatchedFits_Type3Model_AR.rds")
for (i in 1:length(MisMatchedFits_Type3Model)){
  print(MisMatchedFits_Type3Model[[i]], pars = c("r", "B", "b", "e", "delta"),
        probs = c(0.1, 0.5, 0.9), digits = 3)
}
T1Data.T3Model_AR.Fit1 <- MisMatchedFits_Type3Model[[1]]
T1Data.T3Model_AR.Fit2 <- MisMatchedFits_Type3Model[[2]]
T1Data.T3Model_AR.Fit3 <- MisMatchedFits_Type3Model[[3]]
T1Data.T3Model_AR.Fit4 <- MisMatchedFits_Type3Model[[4]]
T1Data.T3Model_AR.Fit5 <- MisMatchedFits_Type3Model[[5]]
T2Data.T3Model_AR.Fit1 <- MisMatchedFits_Type3Model[[6]]
T2Data.T3Model_AR.Fit2 <- MisMatchedFits_Type3Model[[7]]
T2Data.T3Model_AR.Fit3 <- MisMatchedFits_Type3Model[[8]]
T2Data.T3Model_AR.Fit4 <- MisMatchedFits_Type3Model[[9]]
T2Data.T3Model_AR.Fit5 <- MisMatchedFits_Type3Model[[10]]
```
