...
P <- c(); I <- c()
P[1] = 10; I[1] = 10
ts = 0.1; t_stop = 120/ts
for (t in 2:t_stop){
  P[t] = (1 + r*ts - (1-exp(-B*I[t - 1]*ts)))*P[t - 1]
  I[t] = (1 + b*ts*(1/I[t - 1]) + e*(B*P[t - 1])*ts - (1-exp(-delta*ts)))*I[t - 1]
}
ModFentonPerkins_Det <- data.frame(seq(0.1, 120, 0.1), P, I); colnames(ModFentonPerkins_Det) <- c("Time", "P", "I")
...
for (i in 1:length(seeds)){
  ...
  ModFentonPerkins_Stoch <- cbind(seq(0.1, 120, 0.1), ModFentonPerkins_Stoch)
...
plot(ModFentonPerkins_Stoch_List[[1]]$Time, ModFentonPerkins_Stoch_List[[1]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DivOsc (1)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
...
plot(ModFentonPerkins_Stoch_List[[2]]$Time, ModFentonPerkins_Stoch_List[[2]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DivOsc (2)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
...
plot(ModFentonPerkins_Stoch_List[[3]]$Time, ModFentonPerkins_Stoch_List[[3]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DivOsc (3)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
...
plot(ModFentonPerkins_Stoch_List[[4]]$Time, ModFentonPerkins_Stoch_List[[4]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DivOsc (4)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
...
plot(ModFentonPerkins_Stoch_List[[5]]$Time, ModFentonPerkins_Stoch_List[[5]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DivOsc (5)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
...
plot(ModFentonPerkins_Det$Time, ModFentonPerkins_Det$P, type = "l", col = "forestgreen", lty = 1, lwd = 3,
     main = " ", xlab = "Time", ylab = "Abundance", ylim = c(0, 4000))
...
ModFentonPerkins_Est <- data.frame(seq(0.1, 120, 0.1), P, I); colnames(ModFentonPerkins_Est) <- c("Time", "P", "I")
...
par(mfrow = c(1, 1))
plot(ModFentonPerkins_Det$Time, ModFentonPerkins_Det$P, type = "l", col = "forestgreen", lty = 1, lwd = 3,
     main = " ", xlab = "Time", ylab = "Abundance", ylim = c(0, 600))
lines(ModFentonPerkins_Det$Time, ModFentonPerkins_Det$I, col = "cornflowerblue", lty = 1, lwd = 3)
...
par(mfrow = c(2, 3))
plot(ModFentonPerkins_Stoch_List[[1]]$Time, ModFentonPerkins_Stoch_List[[1]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, SLC (1)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[1]]$Time, ModFentonPerkins_Stoch_List[[1]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[2]]$Time, ModFentonPerkins_Stoch_List[[2]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, SLC (2)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[2]]$Time, ModFentonPerkins_Stoch_List[[2]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[3]]$Time, ModFentonPerkins_Stoch_List[[3]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, SLC (3)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[3]]$Time, ModFentonPerkins_Stoch_List[[3]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[4]]$Time, ModFentonPerkins_Stoch_List[[4]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, SLC (4)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[4]]$Time, ModFentonPerkins_Stoch_List[[4]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[5]]$Time, ModFentonPerkins_Stoch_List[[5]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, SLC (5)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[5]]$Time, ModFentonPerkins_Stoch_List[[5]]$I, col = "cornflowerblue")
...
par(mfrow = c(2, 3))
plot(ModFentonPerkins_Stoch_List[[1]]$Time, ModFentonPerkins_Stoch_List[[1]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DampOsc (1)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[1]]$Time, ModFentonPerkins_Stoch_List[[1]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[2]]$Time, ModFentonPerkins_Stoch_List[[2]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DampOsc (2)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[2]]$Time, ModFentonPerkins_Stoch_List[[2]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[3]]$Time, ModFentonPerkins_Stoch_List[[3]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DampOsc (3)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[3]]$Time, ModFentonPerkins_Stoch_List[[3]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[4]]$Time, ModFentonPerkins_Stoch_List[[4]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DampOsc (4)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[4]]$Time, ModFentonPerkins_Stoch_List[[4]]$I, col = "cornflowerblue")

plot(ModFentonPerkins_Stoch_List[[5]]$Time, ModFentonPerkins_Stoch_List[[5]]$P, type = "l", col = "forestgreen",
     main = "Stoch. of Discrete Mod. Fenton and Perkins (2010) Model, Type II, DampOsc (5)", xlab = "Time", ylab = "Abundance", ylim = c(0, max(ModFentonPerkins_Stoch[ , 2:3])))
lines(ModFentonPerkins_Stoch_List[[5]]$Time, ModFentonPerkins_Stoch_List[[5]]$I, col = "cornflowerblue")
...
ts = 0.1; t_stop = 100/ts
for (t in 2:t_stop){
  P[t] = (1 + r*ts - (1-exp((-B/(1 + B*h*P[t - 1]^2))*I[t - 1]*ts)))*P[t - 1]^2
...
DiscreteModel_Dem <- function(P_Last, I_Last){
  ...
  P_B = rpois(1, r*P_Last*ts) 
  P_D = rbinom(1, P_Last^2, (1-exp((-B/(1 + B*h*P_Last^2))*I_Last*ts))) 
...
model {
  ...
  sigma ~ lognormal(-1, 1);
  for (t in 2:N) {
    P[t] ~ normal((1 + r*0.1 - (1-exp((-B/(1 + B*h*P[t - 1]^2))*I[t - 1]*0.1)))*P[t - 1]^2, sigma);
