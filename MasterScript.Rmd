...
MisMatchedData_23_StanData_List <- MisMatchedData_StanData_List[6:15]
...
MisMatchedData_13_StanData_List <- list(MisMatchedData_StanData_List[1:5], MisMatchedData_StanData_List[11:15])
...
MisMatchedData_12_StanData_List <- MisMatchedData_StanData_List[1:10]
MisMatchedFits_Type3Model <- list()
for(i in 1:10){
  Fit <- sampling(MFP_III_Model, data = MisMatchedData_23_StanData_List[[i]], chains = 4, iter = 2000, cores = 4, seed = 123)
