...
## Wrangling 2
Est.MFP1.TS2 <- data.frame(Output.MFP1.TS2$y_rep); Est.Means.MFP1.TS2 <- Est.MFP1.TS2 %>% summarise(across(.cols = everything(),
                                                                                                           .fns = mean))
Est.MFP1.TS3 <- data.frame(Output.MFP1.TS3$y_rep); Est.Means.MFP1.TS3 <- Est.MFP1.TS3 %>% summarise(across(.cols = everything(),
                                                                                                           .fns = mean))
Est.MFP2.DO.TS1 <- data.frame(Output.MFP2.DO.TS1$y_rep); Est.Means.MFP2.DO.TS1 <- Est.MFP2.DO.TS1 %>% summarise(across(.cols = everything(),
                                                                                                                       .fns = mean))
Est.MFP2.SLC.TS2 <- data.frame(Output.MFP2.SLC.TS2$y_rep); Est.Means.MFP2.SLC.TS2 <- Est.MFP2.SLC.TS2 %>% summarise(across(.cols = everything(),
                                                                                                                           .fns = mean))
Est.MFP2.SLC.TS3 <- data.frame(Output.MFP2.SLC.TS3$y_rep); Est.Means.MFP2.SLC.TS3 <- Est.MFP2.SLC.TS3 %>% summarise(across(.cols = everything(),
                                                                                                                           .fns = mean))
Est.MFP2.SLC.TS4 <- data.frame(Output.MFP2.SLC.TS4$y_rep); Est.Means.MFP2.SLC.TS4 <- Est.MFP2.SLC.TS4 %>% summarise(across(.cols = everything(),
                                                                                                                           .fns = mean))
Est.MFP2.SLC.TS5 <- data.frame(Output.MFP2.SLC.TS5$y_rep); Est.Means.MFP2.SLC.TS5 <- Est.MFP2.SLC.TS5 %>% summarise(across(.cols = everything(),
                                                                                                                           .fns = mean))
Est.MFP2.DivOsc.TS1 <- data.frame(Output.MFP2.DivOsc.TS1$y_rep); Est.Means.MFP2.DivOsc.TS1 <- Est.MFP2.DivOsc.TS1 %>% summarise(across(.cols = everything(),
                                                                                                                                       .fns = mean))
Est.MFP2.DivOsc.TS3 <- data.frame(Output.MFP2.DivOsc.TS3$y_rep); Est.Means.MFP2.DivOsc.TS3 <- Est.MFP2.DivOsc.TS3 %>% summarise(across(.cols = everything(),
                                                                                                                                       .fns = mean))
Est.MFP2.DivOsc.TS4 <- data.frame(Output.MFP2.DivOsc.TS4$y_rep); Est.Means.MFP2.DivOsc.TS4 <- Est.MFP2.DivOsc.TS4 %>% summarise(across(.cols = everything(),
                                                                                                                                       .fns = mean))
Est.MFP3.TS5 <- data.frame(Output.MFP3.TS5$y_rep); Est.Means.MFP3.TS5 <- Est.MFP3.TS5 %>% summarise(across(.cols = everything(),
                                                                                                           .fns = mean))
## Wrangling 2
