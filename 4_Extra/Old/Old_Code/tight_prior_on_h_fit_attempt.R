...
July1_Data <- July1_SLC$data 
July1_Data <- as.data.frame(July1_Data)
write_csv(July1_Data,here('./Data/NewData.csv'))
July1_Plot <- ggplot(July1_Data,aes(x=t))+
...
model2 <- stan_model("July2.stan")
NewData = read_csv(here('./Data/NewData.csv'))
...
fit2_Trace <- stan_trace(fit2,parms)
...
fit2_Highlight_1 <- mcmc_trace_highlight(fit2,pars=parms,highlight=1)
fit2_Highlight_2 <- mcmc_trace_highlight(fit2,pars=parms,highlight=2)
fit2_Highlight_3 <- mcmc_trace_highlight(fit2,pars=parms,highlight=3)
fit2_Highlight_4 <- mcmc_trace_highlight(fit2,pars=parms,highlight=4)
fit2_Trace
fit2_Dens
fit2_Overlay
fit2_Violin
